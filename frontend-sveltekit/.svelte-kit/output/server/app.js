...
const Footer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div class="${"row bg-white text-dark align-items-center"}"><div class="${"row bg-white text-dark align-items-center px-5 py-2 "}" style="${"min-height:15vh;"}"><div class="${"col-sm-12 col-md-2 text-center"}"><a href="${"#up"}"><img src="${"/favicon_128x128.png"}" alt="${"logo en projection transition en bas de page"}"></a></div>
        <div class="${"col-sm-12 col-md-8 text-center"}"><div class="${"row align-items-center"}"><div class="${"col text-center"}"><span class="${"mx-3 fw-bold "}" style="${"font-size:1.2rem; cursor:pointer;"}">QUI SOMMES NOUS</span>
                    <span class="${"fw-bold "}" style="${"font-size:1.2rem;"}">|</span>
                    <span class="${"mx-3 fw-bold "}" style="${"font-size:1.2rem; cursor:pointer;"}">PRESSE</span>
                    <span class="${"fw-bold "}" style="${"font-size:1.2rem;"}">|</span>
                    <span class="${"mx-3 fw-bold "}" style="${"font-size:1.2rem; cursor:pointer;"}">ARCHIVES 2020</span></div></div>
            <div class="${"row align-items-center"}"><div class="${"col text-center"}"><span class="${"mx-3 fw-bold "}" style="${"font-size:1.2rem; cursor:pointer;"}">MENTIONS LEGALES</span></div></div></div>
        
        <div class="${"col-sm-12 col-md-2 text-center"}"><div class="${"row my-1"}"><div class="${"col text-center"}" style="${"font-size:1.4rem"}"><span class="${"fw-bold"}" style="${"margin: 15px 15px;"}"><a class="${""}" target="${"_self"}" href="${"/informationsPratiques#contact"}"><i class="${"bi bi-envelope-fill text-dark"}"></i></a></span>
                    <span class="${"fw-bold"}" style="${"margin: 15px 15px;"}"><a class="${""}" target="${"_blank"}" href="${"https://www.facebook.com/FestivalProjectionTransition/"}"><i class="${"bi bi-facebook text-dark"}"></i></a></span>
                    <span class="${"fw-bold"}" style="${"margin: 15px 15px;"}"><a class="${""}" target="${"_blank"}" href="${"https://www.instagram.com/projectiontransition/"}"><i class="${"bi bi-instagram text-dark"}"></i></a></span></div></div></div></div>
    ...
    ${validate_component(ModalBody, "ModalBody").$$render($$result, {}, {}, {
        default: () => `${validate_component(Row, "Row").$$render($$result, {}, {}, {
          default: () => `${validate_component(Col, "Col").$$render($$result, { class: `col` }, {}, {
            ...
            <p class="${"my-3"}"><strong>Pr\xE9visualisation</strong></p>
            <div class="${"row"}"><div class="${escape$4(null_to_empty(`col ${textAlign}`)) + " svelte-rrm9yk"}"><figure class="${"figure m-0 p-0"}"${add_attribute("style", `transform: rotate(${transformR}deg) translateX(${transformX}vh) translateY(${transformY}vh) scale(${scaleXY});`, 0)}><img${add_attribute("src", `${API_URL2}${values[0].url}`, 0)}${add_attribute("alt", values[0].substitution, 0)} class="${escape$4(null_to_empty(`figure-img img-fluid m-0 p-0 ${rounded} ${shadow}`)) + " svelte-rrm9yk"}"${add_attribute("style", `max-height:${maxHeight}vh;max-width:auto;`, 0)}>
...
<div class="${"content-container svelte-rrm9yk"}"><div class="${"row"}"><div class="${escape$4(null_to_empty(`col ${textAlign}`)) + " svelte-rrm9yk"}">${!values[0].url ? `<div class="${"bg-secondary text-center text-dark rounded-3"}" style="${"min-height:100px;"}">Ajouter l&#39;image</div>` : ``}
            <a${add_attribute("href", values[0].redirection ? values[0].redirection : "#", 0)}${add_attribute("target", values[0].redirection ? values[0].redirection.match(/^http/i) ? "_blank" : "_self" : "_self", 0)}><figure class="${"figure m-0 p-0"}"${add_attribute("style", `transform: rotate(${transformR}deg) translateX(${transformX}vh) translateY(${transformY}vh) scale(${scaleXY});`, 0)}><img${add_attribute("src", `${API_URL2}${values[0].url}`, 0)}${add_attribute("alt", values[0].substitution, 0)} class="${escape$4(null_to_empty(`figure-img img-fluid m-0 p-0 ${rounded} ${shadow}`)) + " svelte-rrm9yk"}"${add_attribute("style", `max-height:${maxHeight}vh;max-width:auto;`, 0)}>
                    <figcaption class="${"figure-caption"}">${escape$4(values[0].caption)}</figcaption></figure></a></div></div>

    ${admin ? `<div class="${"middle svelte-rrm9yk"}">${validate_component(EditButton, "EditButton").$$render($$result, { admin, updateContent, edit: edit2 }, {
      edit: ($$value) => {
        edit2 = $$value;
        $$settled = false;
      }
...
<div class="${"moving-container row pt-3 gx-3 svelte-1dwm0ze"}">${each(values[1].values, (partenaire, position) => `<div class="${"col-sm-6 col-md-3 text-center"}">${validate_component(MovingContent, "MovingContent").$$render($$result, {
      array: values[1].values,
      position,
      admin,
      updateMovedArray
...
const ProgrammationComponent = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    <div class="${"col text-start"}">${admin ? `<input type="${"texte"}" placeholder="${"Date de l'\xE9v\xE9nement"}"${add_attribute("value", values[0].date, 0)}>` : `<h1><span class="${"text-white bg-primary text-center px-1"}">${escape$4(values[0].date ? values[0].date.toUpperCase() : "Journ\xE9e ?")}</span></h1>`}</div></div>
...
const SouslligneComponent = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    marginTop = styles.filter((x) => x.name === "marginTop")[0] ? styles.filter((x) => x.name === "marginTop")[0].value : 0;
    marginBottom = styles.filter((x) => x.name === "marginBottom")[0] ? styles.filter((x) => x.name === "marginBottom")[0].value : 0;
    $$rendered = `<div class="${"content-container row svelte-1jg05mq"}"><div class="${"col"}"><div class="${"border-top border-5 border-primary"}"${add_attribute("style", `max-width: ${width}vh; margin-top:${marginTop}px;margin-bottom:${marginBottom}px;`, 0)}>${admin ? `<div class="${"middle svelte-1jg05mq"}">${validate_component(EditButton, "EditButton").$$render($$result, { admin, updateContent, edit: edit2 }, {
      edit: ($$value) => {
        edit2 = $$value;
        $$settled = false;
      }
    }, {})}</div>` : ``}</div></div>
    ${edit2 ? `<div class="${"col-2 parametres svelte-1jg05mq"}"><label for="${"inputWidth"}">Largeur en % de la largeur totale</label>
            ...
            <label for="${"marginBottom"}">Marge au dessous en pixels</label>
            <input id="${"marginBottom"}" type="${"number"}" class="${"form-control"}"${add_attribute("value", marginBottom, 0)}${add_attribute("min", 0, 0)}></div>` : ``}
</div>`;
  } while (!$$settled);
  return $$rendered;
});
