...
const module_lookup = {
  ...
  "src/routes/old/index.svelte": () => Promise.resolve().then(function() {
    return index;
  }),
      ...
      default: () => `${validate_component(Nav, "Nav").$$render($$result, {
        ...
        default: () => `${validate_component(Dropdown, "Dropdown").$$render($$result, { nav: true, inNavbar: true }, {}, {
          ...
          default: () => `${validate_component(DropdownToggle, "DropdownToggle").$$render($$result, {
            ...
            default: () => `<span class="${"titre svelte-azukai"}">PROJET PEDAGOGIQUE</span>`
          })}
                ${validate_component(DropdownMenu, "DropdownMenu").$$render($$result, { end: true, class: "bg-white" }, {}, {
            default: () => `${validate_component(DropdownItem, "DropdownItem").$$render($$result, { class: "bg-white" }, {}, {
              default: () => `${validate_component(NavItem, "NavItem").$$render($$result, {}, {}, {
                default: () => `${validate_component(NavLink, "NavLink").$$render($$result, {}, {}, {
                  default: () => `<span class="${"item svelte-azukai"}">Pr\xE9sentation</span>`
                })}`
              })}`
            })}
                  ${validate_component(DropdownItem, "DropdownItem").$$render($$result, { class: "bg-white" }, {}, {
              default: () => `${validate_component(NavItem, "NavItem").$$render($$result, {}, {}, {
                default: () => `${validate_component(NavLink, "NavLink").$$render($$result, {}, {}, {
                  default: () => `<span class="${"item svelte-azukai"}">Mots des professeurs</span>`
                })}`
              })}`
            })}
                  ${validate_component(DropdownItem, "DropdownItem").$$render($$result, { class: "bg-white" }, {}, {
              default: () => `${validate_component(NavItem, "NavItem").$$render($$result, {}, {}, {
                default: () => `${validate_component(NavLink, "NavLink").$$render($$result, {}, {}, {
                  default: () => `<span class="${"item svelte-azukai"}">El\xE8ves</span>`
                })}`
              })}`
            })}`
          })}`
...
const META = {
  title: "Projection Transition",
  description: "Retrouvez toutes les informations sur le festival Projection Transition",
  keywords: "\xE9cologie, transition, projection transition, cin\xE9ma, shiftProject",
  robots: "index, follow",
  canonical: "https://dev.projtran.jprdev.ovh/",
  og_type: "website",
  og_image: "images/logo-projection-transition.png",
  og_twitter_image: "images/og_logo.jpg"
};
var config = {
  SVELTE_ENV,
  API_URL_DEV,
...
<div class="${"content-container svelte-2sm8o1"}"><div class="${"row"}"><div class="${escape$4(null_to_empty(`col ${textAlign}`)) + " svelte-2sm8o1"}">${!values[0].url ? `<div class="${"bg-secondary text-center text-white"}" style="${"min-height:100px;"}">Image</div>` : ``}
      ...
      default: () => `${validate_component(ModalHeader, "ModalHeader").$$render($$result, { toggle }, {}, { default: () => `Ajouter un contenu` })}
        ...
        default: () => `<div class="${"row"}"><div class="${"col"}"><textarea name="${"textarea"}" id="${"input-textarea"}" class="${"my-3 form-control"}">${values[0].value || ""}</textarea>
          ...
          class: `text-${color}`
                    ...
                    <div class="${"row py-1"}"><div class="${"col"}"><button class="${"btn btn-light p-1"}"><span>p-1</span></button>
...
var MovingContent_svelte_svelte_type_style_lang = ".moving-container.svelte-187qscu{-webkit-transform:scale(1);transform:scale(1);transition:.5s ease;border:dashed 1px}.moving-container.svelte-187qscu:hover{-webkit-transform:scale(1.03);transform:scale(1.03);transition:.5s ease}";
const css$6 = {
...
const MovingContent = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${admin ? `<div class="${"moving-container border-light rounded-3 mt-3 mb-1 p-3 bg-lavande shadow-lg svelte-187qscu"}">${validate_component(Row, "Row").$$render($$result, { class: "align-items-center" }, {}, {
    default: () => `${validate_component(Col, "Col").$$render($$result, { class: "text-center mb-2" }, {}, {
      default: () => `${validate_component(Button, "Button").$$render($$result, { class: "mx-3", color: "secondary" }, {}, {
        default: () => `${validate_component(Icon, "Icon").$$render($$result, { name: "caret-up" }, {}, {})}  UP`
      })}
                ${validate_component(Button, "Button").$$render($$result, { class: "mx-3", color: "secondary" }, {}, {
        default: () => `${validate_component(Icon, "Icon").$$render($$result, { name: "caret-down" }, {}, {})}  DOWN`
      })}
                ${validate_component(Button, "Button").$$render($$result, { class: "mx-3", color: "danger" }, {}, {
        default: () => `${validate_component(Icon, "Icon").$$render($$result, { name: "trash" }, {}, {})}  DELETE`
      })}`
    })}`
  })}
        ${slots.default ? slots.default({}) : ``}</div>` : `<span>${slots.default ? slots.default({}) : ``}</span>`}`;
});
...
const U5Bidu5D = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    $$settled = true;
    isAuthenticate = $userInfo && $userInfo.profil === "admin" ? true : false;
    $$rendered = `${$$result.head += `${$$result.title = `<title>Projection Transition ${escape$4(filmRequest2.film.title.values.length ? filmRequest2.film.title.values[0].value.replaceAll(/[#|*|_]/g, "") : "")}</title>`, ""}<meta name="${"description"}"${add_attribute("content", `Retrouvez toutes les informations sur le festival Projection Transition ${filmRequest2.film.title.values.length ? filmRequest2.film.title.values[0].value.replaceAll(/[#|*|_]/g, "") : ""}`, 0)} data-svelte="svelte-1jlgfn6"><meta name="${"keywords"}" content="${"\xE9cologie, transition, projection transition, cin\xE9ma, shiftProject, cine-debat"}" data-svelte="svelte-1jlgfn6"><meta property="${"og:title"}"${add_attribute("content", `Projection Transition - Participez \xE0 la projection de ${filmRequest2.film.title.values.length ? filmRequest2.film.title.values[0].value.replaceAll(/[#|*|_]/g, "") : ""}`, 0)} data-svelte="svelte-1jlgfn6"><meta property="${"og:type"}" content="${"website"}" data-svelte="svelte-1jlgfn6"><meta property="${"og:image"}"${add_attribute("content", `${API_URL2}/images/og_logo.jpg`, 0)} data-svelte="svelte-1jlgfn6"><meta property="${"og:image:width"}" content="${"800"}" data-svelte="svelte-1jlgfn6"><meta property="${"og:image:height"}" content="${"400"}" data-svelte="svelte-1jlgfn6"><meta property="${"og:url"}"${add_attribute("content", `${page2.host}${page2.path}/`, 0)} data-svelte="svelte-1jlgfn6"><meta property="${"og:locale"}" content="${"fr_FR"}" data-svelte="svelte-1jlgfn6"><meta name="${"twitter:image"}"${add_attribute("content", `${API_URL2}/images/og_logo.jpg`, 0)} data-svelte="svelte-1jlgfn6"><meta name="${"twitter:card"}" content="${"summary_large_image"}" data-svelte="svelte-1jlgfn6"><meta name="${"twitter:description"}"${add_attribute("content", `Projection Transition - Participez \xE0 la projection de ${filmRequest2.film.title.values.length ? filmRequest2.film.title.values[0].value.replaceAll(/[#|*|_]/g, "") : ""}`, 0)} data-svelte="svelte-1jlgfn6">`, ""}

${isAuthenticate ? `${validate_component(AdminButton, "AdminButton").$$render($$result, { isAuthenticate, admin }, {
      admin: ($$value) => {
        admin = $$value;
        $$settled = false;
      }
...
const Old = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      default: () => `${validate_component(Col, "Col").$$render($$result, {}, {}, {
        default: () => `<div class="${"content svelte-14apyyo"}">${validate_component(Carousel, "Carousel").$$render($$result, {
          ...
          default: () => `
            ...
            <div class="${"carousel-inner"}">${each(values, (item, index2) => `${validate_component(CarouselItem, "CarouselItem").$$render($$result, { itemIndex: index2, activeIndex }, {
            activeIndex: ($$value) => {
              activeIndex = $$value;
              $$settled = false;
            }
...
const ProgrammationComponent = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    <div class="${"col text-start"}">${admin ? `<input type="${"texte"}" placeholder="${"Date de l'\xE9v\xE9nement"}"${add_attribute("value", values[0].date, 0)}>` : `<h4><span class="${"text-white bg-primary text-center px-1"}">${escape$4(values[0].date ? values[0].date.toUpperCase() : "Journ\xE9e ?")}</span></h4>`}</div></div>
<div class="${"row mt-2"}">${values[1] && values[1].values ? `${each(values[1].values, (evenement, position) => `<div class="${"col-sm-12 col-md-6 my-4"}">${validate_component(MovingContent, "MovingContent").$$render($$result, {
      ...
      default: () => `<div class="${"p-3 bg-white rounded-3 event-container svelte-kurlj3"}"><div class="${"image-container svelte-kurlj3"}"><div class="${"image my-auto svelte-kurlj3"}">${validate_component(ImageComponent, "ImageComponent").$$render($$result, {
        ...
        ${admin ? `<div class="${"row"}"><div class="${"col text-center"}"><button class="${"btn btn-primary text-center"}">Add Event</button></div></div>` : ``}
...
const LayoutComponent = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    border = styles.filter((x) => x.name === "border")[0] && styles.filter((x) => x.name === "border")[0].value;
    borderColor = styles.filter((x) => x.name === "border-color")[0] && styles.filter((x) => x.name === "border-color")[0].value;
    $$rendered = `<div class="${"content-container svelte-1jdtaij"}">${admin ? `<div class="${"middle svelte-1jdtaij"}">${validate_component(EditButton, "EditButton").$$render($$result, { admin, updateContent, edit: edit2 }, {
      edit: ($$value) => {
        edit2 = $$value;
        $$settled = false;
      }
      ...
      default: () => `${validate_component(ModalHeader, "ModalHeader").$$render($$result, { toggle }, {}, { default: () => `Editer le layout` })}
        ...
        default: () => `<div class="${"row align-items-center"}"><div class="${"col"}"><label for="${"input-columns"}" class="${"form-label"}">Nombre de colonnes *</label>
          ...
          class: `text-${color}`
                ...
                <p class="${"my-3"}"><strong>Pr\xE9visualisation</strong></p>
                <div class="${escape$4(null_to_empty(`row gx-2 align-items-${alignContent} ${bgColor} ${padding} ${marginX} ${marginY} ${rounded} ${border} ${borderColor}`)) + " svelte-1jdtaij"}">${each(values, (column, position) => `<div class="${escape$4(null_to_empty(`col-sm-12 col-md-${md.toString()} border border-light`)) + " svelte-1jdtaij"}" style="${escape$4(`min-height: 5vh;`) + ";"}">Colonne ${escape$4(position)}
    ...
    <div class="${escape$4(null_to_empty(`row gx-2 content align-items-${alignContent} ${bgColor} ${padding} ${marginX} ${marginY} ${rounded} ${border} ${borderColor}`)) + " svelte-1jdtaij"}">${each(values, (column, position) => `<div class="${escape$4(null_to_empty(`col-sm-12 col-md-${md.toString()}`)) + " svelte-1jdtaij"}" style="${escape$4(`min-height: 5vh;`) + ";"}">${validate_component(MovingContent, "MovingContent").$$render($$result, {
      array: values,
      position,
      admin,
      updateMovedArray
        ...
        default: () => `${validate_component(DisplayCustomComponent, "DisplayCustomComponent").$$render($$result, {
          ...
          styles: ($$value) => {
            ...
            $$settled = false;
                ...
                ${admin ? `
                    ${validate_component(AddContent, "AddContent").$$render($$result, { admin, position, addToLayout }, {}, {})}` : ``}
...
const AddContent = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    $$settled = true;
    $$rendered = `${validate_component(Row, "Row").$$render($$result, { class: "my-3 pt-3" }, {}, {
      default: () => `${validate_component(Col, "Col").$$render($$result, {}, {}, {
        default: () => `${validate_component(Button, "Button").$$render($$result, { color: "primary", class: "my-3" }, {}, { default: () => `Ajouter un contenu` })}
    ...
    ${validate_component(Modal, "Modal").$$render($$result, {
      ...
      ${validate_component(ModalBody, "ModalBody").$$render($$result, {}, {}, {
        ...
        ${validate_component(Row, "Row").$$render($$result, { class: "mt-5" }, {}, {
              default: () => `${validate_component(Col, "Col").$$render($$result, {}, {}, {
                default: () => `${validate_component(DisplayCustomComponent, "DisplayCustomComponent").$$render($$result, {
                  type,
                  updateContent: null,
...
const U5B_datau5D = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `${$$result.head += `${$$result.title = `<title>Projection Transition ${escape$4(params.name)}</title>`, ""}<meta name="${"description"}"${add_attribute("content", `Retrouvez toutes les informations sur le festival Projection Transition ${params.name ? params.name : ""}`, 0)} data-svelte="svelte-316wul"><meta name="${"keywords"}" content="${"\xE9cologie, transition, projection transition, cin\xE9ma, shiftProject, cine-debat"}" data-svelte="svelte-316wul"><meta property="${"og:title"}"${add_attribute("content", `Projection Transition - Le festival cin\xE9-d\xE9bat pour la transition \xE9cologique - ${params.name ? params.name : ""}`, 0)} data-svelte="svelte-316wul"><meta property="${"og:type"}" content="${"website"}" data-svelte="svelte-316wul"><meta property="${"og:image"}"${add_attribute("content", `${API_URL2}/images/og_logo.jpg`, 0)} data-svelte="svelte-316wul"><meta property="${"og:image:width"}" content="${"800"}" data-svelte="svelte-316wul"><meta property="${"og:image:height"}" content="${"400"}" data-svelte="svelte-316wul"><meta property="${"og:url"}"${add_attribute("content", `${page2.host}${page2.path}/`, 0)} data-svelte="svelte-316wul"><meta property="${"og:locale"}" content="${"fr_FR"}" data-svelte="svelte-316wul"><meta name="${"twitter:image"}"${add_attribute("content", `${API_URL2}/images/og_logo.jpg`, 0)} data-svelte="svelte-316wul"><meta name="${"twitter:card"}" content="${"summary_large_image"}" data-svelte="svelte-316wul"><meta name="${"twitter:description"}" content="${"Retrouvez toutes les informations sur le festival Projection Transition"}" data-svelte="svelte-316wul">`, ""}
...
${pageRequest2.loading ? `${validate_component(Loading, "Loading").$$render($$result, { color: "secondary", number: 3 }, {}, {})}` : `${validate_component(CustomContainer, "CustomContainer").$$render($$result, {}, {}, {
      default: () => `${validate_component(Row, "Row").$$render($$result, { class: "mt-3" }, {}, {
        default: () => `${validate_component(Col, "Col").$$render($$result, {}, {}, {
          default: () => `${admin ? `${validate_component(AddContent, "AddContent").$$render($$result, { admin, addContent }, {}, {})}` : ``}
                ${pageRequest2.content && pageRequest2.content.content ? `${each(pageRequest2.content.content, (section, position) => `${validate_component(MovingContent, "MovingContent").$$render($$result, {
