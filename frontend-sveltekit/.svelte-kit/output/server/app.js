...
const U5Bidu5D = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    $$settled = true;
    isAuthenticate = $userInfo && $userInfo.profil === "admin" ? true : false;
    $$rendered = `${$$result.head += `${$$result.title = `<title>Projection Transition ${escape$4(filmRequest2.film && filmRequest2.film.title.values.length ? filmRequest2.film.title.values[0].value.replaceAll(/[#|*|_]/g, "") : "")}</title>`, ""}<meta name="${"description"}"${add_attribute("content", `Retrouvez toutes les informations sur le festival Projection Transition ${filmRequest2.film && filmRequest2.film.title.values.length ? filmRequest2.film.title.values[0].value.replaceAll(/[#|*|_]/g, "") : ""}`, 0)} data-svelte="svelte-1svk393"><meta name="${"keywords"}" content="${"\xE9cologie, transition, projection transition, cin\xE9ma, shiftProject, cine-debat"}" data-svelte="svelte-1svk393"><meta property="${"og:title"}"${add_attribute("content", `Projection Transition - Participez \xE0 la projection de ${filmRequest2.film && filmRequest2.film.title.values.length ? filmRequest2.film.title.values[0].value.replaceAll(/[#|*|_]/g, "") : ""}`, 0)} data-svelte="svelte-1svk393"><meta property="${"og:type"}" content="${"website"}" data-svelte="svelte-1svk393"><meta property="${"og:image"}"${add_attribute("content", `${SITE_URL}/images/og_logo.jpg`, 0)} data-svelte="svelte-1svk393"><meta property="${"og:image:width"}" content="${"800"}" data-svelte="svelte-1svk393"><meta property="${"og:image:height"}" content="${"400"}" data-svelte="svelte-1svk393"><meta property="${"og:url"}"${add_attribute("content", `${page2.host}${page2.path}`, 0)} data-svelte="svelte-1svk393"><meta property="${"og:locale"}" content="${"fr_FR"}" data-svelte="svelte-1svk393"><meta name="${"twitter:image"}"${add_attribute("content", `${SITE_URL}/images/og_logo.jpg`, 0)} data-svelte="svelte-1svk393"><meta name="${"twitter:card"}" content="${"summary_large_image"}" data-svelte="svelte-1svk393"><meta name="${"twitter:description"}"${add_attribute("content", `Projection Transition - Participez \xE0 la projection de ${filmRequest2.film && filmRequest2.film.title.values.length ? filmRequest2.film.title.values[0].value.replaceAll(/[#|*|_]/g, "") : ""}`, 0)} data-svelte="svelte-1svk393">`, ""}
...
const U5B_datau5D = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    $$settled = true;
    isAuthenticate = $userInfo && $userInfo.profil === "admin" ? true : false;
    $$rendered = `${$$result.head += `${$$result.title = `<title>Projection Transition ${escape$4(params.name)}</title>`, ""}<meta name="${"description"}"${add_attribute("content", `Retrouvez toutes les informations sur le festival Projection Transition`, 0)} data-svelte="svelte-2vlukd"><meta name="${"keywords"}" content="${"\xE9cologie, transition, projection transition, cin\xE9ma, shiftProject, cine-debat"}" data-svelte="svelte-2vlukd"><meta property="${"og:title"}"${add_attribute("content", `Projection Transition - Le festival cin\xE9-d\xE9bat pour la transition \xE9cologique`, 0)} data-svelte="svelte-2vlukd"><meta property="${"og:type"}" content="${"website"}" data-svelte="svelte-2vlukd"><meta property="${"og:image"}"${add_attribute("content", `${SITE_URL}/images/og_logo.jpg`, 0)} data-svelte="svelte-2vlukd"><meta property="${"og:image:width"}" content="${"800"}" data-svelte="svelte-2vlukd"><meta property="${"og:image:height"}" content="${"400"}" data-svelte="svelte-2vlukd"><meta property="${"og:url"}"${add_attribute("content", `${SITE_URL}${page2.path}`, 0)} data-svelte="svelte-2vlukd"><meta property="${"og:locale"}" content="${"fr_FR"}" data-svelte="svelte-2vlukd"><meta name="${"twitter:image"}"${add_attribute("content", `${SITE_URL}/images/og_logo.jpg`, 0)} data-svelte="svelte-2vlukd"><meta name="${"twitter:card"}" content="${"summary_large_image"}" data-svelte="svelte-2vlukd"><meta name="${"twitter:description"}" content="${"Retrouvez toutes les informations sur le festival Projection Transition"}" data-svelte="svelte-2vlukd">`, ""}
