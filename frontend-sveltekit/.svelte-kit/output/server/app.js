...
const NAV_BAR = {
  TITLE: [
    ...
    {
      name: "PROGRAMMATION 2021",
      url: "/programmation2021",
      SUBTITLE: []
    },
    {
      name: "INFORMATIONS PRATIQUES",
      url: "/informationsPratiques",
      SUBTITLE: []
    },
    {
      name: "BILLETTERIE",
  ...
  SOCIAL_NETWORKS: [
    {
      name: "email",
      icon: "/icones/MAIL.004.png",
      alt: "icone pour envoyer un email",
      redirect: "/informationsPratiques#contact",
      target: ""
    },
    {
      name: "facebook",
      icon: "/icones/FB.004.png",
      alt: "icone pour consulter la page Facebook",
      redirect: "https://www.facebook.com/FestivalProjectionTransition/",
      target: "_blank"
    },
    {
      name: "instagram",
      icon: "/icones/INSTA.004.png",
      alt: "icone pour consulter la page Instagram",
      redirect: "https://www.instagram.com/projectiontransition/",
      target: "_blank"
    },
    {
      name: "youtube",
      icon: "/icones/YT.004.png",
      alt: "icone pour consulter la page Youtube",
  ...
  STYLE: {
    ...
    theme: "light",
    TITLE: {
      bootstrapClass: "text-dark mx-2",
      style: "font-family: omotenashi_2regular;font-size: 1.3rem;"
    },
    SOCIAL_NETWORKS: {
      bootstrapClass: "",
      style: "max-width: 6vh;height: auto;"
    }
  }
};
const FOOTER = {
  ...
  BRAND: {
    LOGO: {
      path: "/images/Logo_Principal.jpg",
      alt: "Logo de projection transition pour remonter en haut de page",
  ...
  COPYRIGHT: {
    value: "\xA92021 Projection Transition",
    style: "ont-size:1rem;",
    bootstrapClass: "mx-3"
  },
  STYLE: {
    ...
    NAVIGATION: {
      bootstrapClass: "row bg-white text-dark align-items-center px-3 py-2 ",
...
const SEO = {
  DEFAULT_TITLE: "Projection Transition",
  DEFAULT_DESCRIPTION: "Projection Transition - Le festival cin\xE9-d\xE9bat pour la transition \xE9cologique",
  DEFAULT_OG_TITLE: "Projection Transition - Le festival cin\xE9-d\xE9bat pour la transition \xE9cologique",
  DEFAULT_OG_DESCRIPTION: "Retrouvez toutes les informations sur le festival Projection Transition",
  DEFAULT_OG_IMAGE: "/images/og_logo.jpg"
};
const SHEETS = {
  FAVICON: {
    _48_48: {
      path: "/favicon_48x48.png"
    },
    _64_64: {
      path: "/favicon_64x64.png"
    },
    _96_96: {
      path: "/favicon_96x96.png"
    },
    _128_128: {
      path: "/favicon_128x128.png"
    },
    _196_196: {
      path: "/favicon_196x196.png"
    }
  }
};
var config = {
...
const Nav_1 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(Navbar, "Navbar").$$render($$result, {
    ...
    default: () => `${validate_component(NavbarBrand, "NavbarBrand").$$render($$result, {}, {}, {
      default: () => `<img class="${"img-fluid"}"${add_attribute("style", config.NAV_BAR.BRAND.LOGO.style, 0)}${add_attribute("src", config.NAV_BAR.BRAND.LOGO.path, 0)}${add_attribute("alt", config.NAV_BAR.BRAND.LOGO.path, 0)}>`
    })}
  <div class="${"mx-auto"}">${each(config.NAV_BAR.SOCIAL_NETWORKS, (item) => `<span class="${"fw-bold"}"><a class="${""}"${add_attribute("target", item.target, 0)}${add_attribute("href", item.redirect, 0)}><img class="${"icone-rs"}"${add_attribute("style", config.NAV_BAR.STYLE.SOCIAL_NETWORKS.style, 0)}${add_attribute("src", item.icon, 0)}${add_attribute("alt", item.alt, 0)}></a></span>`)}</div>
  ...
  ${validate_component(Collapse, "Collapse").$$render($$result, { isOpen, navbar: true, expand }, {}, {
      default: () => `${validate_component(Nav, "Nav").$$render($$result, {
        ...
        default: () => `${each(config.NAV_BAR.TITLE, (item) => `${validate_component(Dropdown, "Dropdown").$$render($$result, { nav: true, inNavbar: true }, {}, {
          default: () => `${validate_component(NavItem, "NavItem").$$render($$result, {}, {}, {
            default: () => `${validate_component(NavLink, "NavLink").$$render($$result, {
              class: config.NAV_BAR.STYLE.TITLE.bootstrapClass,
              style: config.NAV_BAR.STYLE.TITLE.style
            }, {}, {
              default: () => `<span>${escape$4(item.name.toString())}</span>`
            })}`
          })}
        `
        })}`)}`
...
const Footer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div${add_attribute("class", `row ${config.FOOTER.STYLE.FOOTER.bootstrapClass}`, 0)}>${`<div${add_attribute("class", `row ${config.FOOTER.STYLE.NAVIGATION.bootstrapClass}`, 0)}${add_attribute("style", config.FOOTER.STYLE.NAVIGATION.style, 0)}><div class="${"col-3 text-start"}"><a href="${"#up"}"><img class="${"img-fluid mx-2"}"${add_attribute("src", config.FOOTER.BRAND.LOGO.path, 0)}${add_attribute("alt", config.FOOTER.BRAND.LOGO.alt, 0)}${add_attribute("style", config.FOOTER.BRAND.LOGO.style, 0)}></a></div>
            <div class="${"col-6 text-center"}"><div class="${"row align-items-center"}"><div class="${"col text-center"}">${each(config.FOOTER.TITLE, (item, position) => `<span${add_attribute("class", config.FOOTER.STYLE.TITLE.bootstrapClass, 0)}${add_attribute("style", config.FOOTER.STYLE.TITLE.style, 0)}>${escape$4(item.name)}</span>
                            ${position < config.FOOTER.TITLE.length - 1 ? `<span class="${"fw-bold"}"${add_attribute("style", config.FOOTER.STYLE.TITLE.style, 0)}>|</span>` : ``}`)}</div></div></div>
            <div class="${"col-3 text-center"}"><div class="${"row my-1"}"><div class="${"col text-center"}" style="${"font-size:1.4rem"}">${each(config.FOOTER.SOCIAL_NETWORKS, (item) => `<span class="${"fw-bold"}"><a class="${""}"${add_attribute("target", item.target, 0)}${add_attribute("href", item.redirect, 0)}><img${add_attribute("class", config.FOOTER.STYLE.SOCIAL_NETWORKS.bootstrapClass, 0)}${add_attribute("style", config.FOOTER.STYLE.SOCIAL_NETWORKS.style, 0)}${add_attribute("src", item.icon, 0)}${add_attribute("alt", item.alt, 0)}></a></span>`)}</div></div></div></div>`}
    ${`<div${add_attribute("class", `row ${config.FOOTER.STYLE.COPYRIGHT.bootstrapClass}`, 0)}${add_attribute("style", config.FOOTER.STYLE.COPYRIGHT.style, 0)}><div class="${"col text-center"}"><span${add_attribute("class", config.FOOTER.COPYRIGHT.bootstrapClass, 0)}${add_attribute("style", config.FOOTER.COPYRIGHT.style, 0)}>${escape$4(config.FOOTER.COPYRIGHT.value)}</span></div></div>`}</div>`;
});
const prerender$3 = true;
const _layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${$$result.head += `<link rel="${"stylesheet"}" href="${"https://cdn.jsdelivr.net/npm/bootstrap-icons@1.5.0/font/bootstrap-icons.css"}" data-svelte="svelte-x8zd4q"><link rel="${"stylesheet"}" href="${"/mains.min.css"}" data-svelte="svelte-x8zd4q"><link rel="${"icon"}" type="${"image/png"}"${add_attribute("href", config.SHEETS.FAVICON._48_48.path, 0)} sizes="${"48x48"}" data-svelte="svelte-x8zd4q"><link rel="${"icon"}" type="${"image/png"}"${add_attribute("href", config.SHEETS.FAVICON._64_64.path, 0)} sizes="${"64x64"}" data-svelte="svelte-x8zd4q"><link rel="${"icon"}" type="${"image/png"}"${add_attribute("href", config.SHEETS.FAVICON._48_48.path, 0)} sizes="${"96x96"}" data-svelte="svelte-x8zd4q"><link rel="${"icon"}" type="${"image/png"}"${add_attribute("href", config.SHEETS.FAVICON._48_48.path, 0)} sizes="${"128x128"}" data-svelte="svelte-x8zd4q"><link rel="${"icon"}" type="${"image/png"}"${add_attribute("href", config.SHEETS.FAVICON._48_48.path, 0)} sizes="${"196x196"}" data-svelte="svelte-x8zd4q">`, ""}

<div id="${"up"}"></div>

<main>${validate_component(Nav_1, "Nav").$$render($$result, {}, {}, {})}
...
const statisticsSendRequest = writable({ success: false, loading: false, message: "", data: {} });
const statisticsAllPages = writable({ success: false, loading: false, message: "", pages: [] });
const copyComponent = writable(null);
const CustomContainer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { size = { xs: 12, sm: 10, md: 10, lg: 10, xl: 10 } } = $$props;
  if ($$props.size === void 0 && $$bindings.size && size !== void 0)
    $$bindings.size(size);
...
const Statistics = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let $statisticsSendRequest, $$unsubscribe_statisticsSendRequest;
  let $userInfo, $$unsubscribe_userInfo;
  let $statisticsAllPages, $$unsubscribe_statisticsAllPages;
  $$unsubscribe_statisticsSendRequest = subscribe(statisticsSendRequest, (value) => $statisticsSendRequest = value);
  $$unsubscribe_userInfo = subscribe(userInfo, (value) => $userInfo = value);
  $$unsubscribe_statisticsAllPages = subscribe(statisticsAllPages, (value) => $statisticsAllPages = value);
  ...
  $$unsubscribe_statisticsSendRequest();
  $$unsubscribe_userInfo();
  $$unsubscribe_statisticsAllPages();
  return `${validate_component(CustomContainer, "CustomContainer").$$render($$result, {}, {}, {
    default: () => `<h1 class="${"mt-2"}">Statistics</h1>

    <form id="${"statistics"}" class="${"statistics-form"}"><div class="${"row align-items-center mb-3"}"><div class="${"col-sm-12 col-md-6"}"><label for="${"startDateInput"}" class="${"form-label"}">Date de d\xE9but</label>
                <input type="${"date"}" class="${"form-control"}" id="${"startDateInput"}" required${add_attribute("value", startDate, 0)}></div>
            <div class="${"col-sm-12 col-md-6"}"><label for="${"endDateInput"}" class="${"form-label"}">Date de fin</label>
                <input type="${"date"}" class="${"form-control"}" id="${"endDateInput"}" required${add_attribute("value", endDate, 0)}></div></div>
        ${$statisticsAllPages.data ? `<div class="${"row mb-3"}"><div class="${"col"}"><select class="${"form-select"}" multiple aria-label="${"multiple select pages"}">${each($statisticsAllPages.data, (page2) => `<option${add_attribute("value", page2, 0)}>${escape$4(page2)}</option>`)}</select></div></div>` : ``}
        
        <div class="${"row"}"><div class="${"col text-start"}"><button type="${"submit"}" class="${"btn btn-primary"}">Valider</button></div></div></form>


    ${$statisticsSendRequest.loading ? `${validate_component(Loading, "Loading").$$render($$result, { number: 3, color: "primary" }, {}, {})}` : ``}
    ${$statisticsSendRequest.message ? `${validate_component(Message, "Message").$$render($$result, {
      color: $statisticsSendRequest.success ? "primary" : "danger"
    }, {}, {
      default: () => `${escape$4($statisticsSendRequest.message)}`
    })}` : ``}
    <div class="${"row my-3"}"><div class="${"col bg-light rounded p-5"}"><canvas id="${"statisticsChart"}"></canvas></div></div>`
  })}`;
});
...
const API_URL$2 = config.API_URL_PROD;
...
const AdminButton = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${isAuthenticate ? `<div class="${"alert alert-warning text-center my-0"}"><div class="${"row align-items-center"}"><div class="${"col my-auto"}"${add_attribute("sm", 4, 0)}${add_attribute("md", 10, 0)}>You are in admin mode. Be careful!</div>
...
const EditButton = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.edit === void 0 && $$bindings.edit && edit2 !== void 0)
    $$bindings.edit(edit2);
  return `${admin ? `${validate_component(Row, "Row").$$render($$result, { class: "text-end" }, {}, {
    default: () => `${validate_component(Col, "Col").$$render($$result, {}, {}, {
      default: () => `${validate_component(Button, "Button").$$render($$result, { size: "sm", color: "ambre" }, {}, {
...
const ImageComponent = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  let paddingT;
  let paddingB;
  const API_URL2 = config.API_URL_PROD;
  let { values = [] } = $$props;
  let { styles = [] } = $$props;
  let { admin = "false" } = $$props;
  let { edit: edit2 = "false" } = $$props;
        ...
        default: () => `${validate_component(Row, "Row").$$render($$result, {}, {}, {
          default: () => `${validate_component(Col, "Col").$$render($$result, { class: `col` }, {}, {
            ...
            ${validate_component(Input, "Input").$$render($$result, {
              ...
              name: "text",
              class: "my-3",
              placeholder: "[option] url de redirection *",
              value: values[0].redirection
            }, {
              value: ($$value) => {
                values[0].redirection = $$value;
                $$settled = false;
              }
            }, {})}
            <p>* exemple : https://url_cible.com Pour une url externe au site <br>* exemple : /edito pour une url interne au site</p>
            <div class="${"row py-1"}"><div class="${"col"}"><button class="${escape$4(null_to_empty(`px-1 btn ${textAlign === "text-start" ? "btn-primary" : "btn-light"}`)) + " svelte-1hstmha"}">${validate_component(Icon, "Icon").$$render($$result, { name: "text-left" }, {}, {})}</button>
                <button class="${escape$4(null_to_empty(`px-1 btn ${textAlign === "text-center" ? "btn-primary" : "btn-light"}`)) + " svelte-1hstmha"}">${validate_component(Icon, "Icon").$$render($$result, { name: "text-center" }, {}, {})}</button>
                <button class="${escape$4(null_to_empty(`px-1 btn ${textAlign === "text-end" ? "btn-primary" : "btn-light"}`)) + " svelte-1hstmha"}">${validate_component(Icon, "Icon").$$render($$result, { name: "text-right" }, {}, {})}</button></div></div>
            <div class="${"row py-1"}"><div class="${"col"}">${validate_component(Button, "Button").$$render($$result, {
              class: "px-1",
              color: `${shadow === "shadow" ? "primary" : "light"}`
            }, {}, {
              default: () => `${validate_component(Icon, "Icon").$$render($$result, { name: "back" }, {}, {})}`
            })}
                    ${validate_component(Button, "Button").$$render($$result, {
              class: "px-1",
              color: `${shadow === "" ? "primary" : "light"}`
            }, {}, { default: () => `No shadow` })}</div></div>
            <div class="${"row py-1"}"><div class="${"col"}">${validate_component(Button, "Button").$$render($$result, {
              class: "px-1 rounded-3",
              color: `${rounded === "rounded-3" ? "primary" : "light"}`
            }, {}, {
              default: () => `${validate_component(Icon, "Icon").$$render($$result, { name: "app" }, {}, {})}`
            })}
                    ${validate_component(Button, "Button").$$render($$result, {
              class: "px-1 rounded-circle",
              color: `${rounded === "rounded-circle" ? "primary" : "light"}`
            }, {}, { default: () => `Circle` })}
                    ${validate_component(Button, "Button").$$render($$result, {
              class: "px-1",
              color: `${rounded === "" ? "primary" : "light"}`
            }, {}, { default: () => `No rounded` })}</div></div>
            <div class="${"row py-1"}"><div class="${"col"}"><span>Margin Left : </span>
                    <input type="${"number"}"${add_attribute("step", 1, 0)}${add_attribute("min", 0, 0)} class="${"form-control"}"${add_attribute("value", marginL, 0)}></div>
                <div class="${"col"}"><span>Margin Right : </span>
                    <input type="${"number"}"${add_attribute("step", 1, 0)}${add_attribute("min", 0, 0)} class="${"form-control"}"${add_attribute("value", marginR, 0)}></div>
                <div class="${"col"}"><span>Margin Top : </span>
                    <input type="${"number"}"${add_attribute("step", 1, 0)}${add_attribute("min", 0, 0)} class="${"form-control"}"${add_attribute("value", marginT, 0)}></div>
                <div class="${"col"}"><span>Margin Bottom : </span>
                    <input type="${"number"}"${add_attribute("step", 1, 0)}${add_attribute("min", 0, 0)} class="${"form-control"}"${add_attribute("value", marginB, 0)}></div></div>
            <div class="${"row py-1"}"><div class="${"col"}"><span>Padding Left : </span>
                    <input type="${"number"}"${add_attribute("step", 1, 0)}${add_attribute("min", 0, 0)} class="${"form-control"}"${add_attribute("value", paddingL, 0)}></div>
                <div class="${"col"}"><span>Padding Right : </span>
                    <input type="${"number"}"${add_attribute("step", 1, 0)}${add_attribute("min", 0, 0)} class="${"form-control"}"${add_attribute("value", paddingR, 0)}></div>
                <div class="${"col"}"><span>Padding Top : </span>
                    <input type="${"number"}"${add_attribute("step", 1, 0)}${add_attribute("min", 0, 0)} class="${"form-control"}"${add_attribute("value", paddingT, 0)}></div>
                <div class="${"col"}"><span>Padding Bottom : </span>
                    <input type="${"number"}"${add_attribute("step", 1, 0)}${add_attribute("min", 0, 0)} class="${"form-control"}"${add_attribute("value", paddingB, 0)}></div></div>
            ...
            <p class="${"my-3"}"><strong>Pr\xE9visualisation</strong></p>
            <div class="${"row"}"><div class="${escape$4(null_to_empty(`col ${textAlign}`)) + " svelte-1hstmha"}"><figure class="${"figure"}"${add_attribute("style", `transform: rotate(${transformR}deg) scale(${scaleXY});margin-left: ${marginL}rem;margin-right: ${marginR}rem;;margin-top: ${marginT}rem;;margin-bottom: ${marginB}rem;padding-left: ${paddingL}rem;padding-right: ${paddingR}rem;;padding-top: ${paddingT}rem;;padding-bottom: ${paddingB}rem;`, 0)}><img${add_attribute("src", `${API_URL2}${values[0].url}`, 0)}${add_attribute("alt", values[0].substitution, 0)} class="${escape$4(null_to_empty(`figure-img m-0 p-0 ${rounded} ${shadow}`)) + " svelte-1hstmha"}">
...
<div class="${"content-container svelte-1hstmha"}"><div class="${"row"}"><div class="${escape$4(null_to_empty(`col ${textAlign}`)) + " svelte-1hstmha"}">${!values[0].url ? `<div class="${"bg-secondary text-center text-dark rounded-3"}" style="${"min-height:100px;"}">Ajouter l&#39;image</div>` : ``}
            ${values[0].redirection ? `<a${add_attribute("href", values[0].redirection, 0)}${add_attribute("target", values[0].redirection.match(/^http/i) ? "_blank" : "", 0)}><figure class="${"figure"}"${add_attribute("style", `transform: rotate(${transformR}deg) scale(${scaleXY});margin-left: ${marginL}rem;;margin-right: ${marginR}rem;margin-top: ${marginT}rem;;margin-bottom: ${marginB}rem;padding-left: ${paddingL}rem;;padding-right: ${paddingR}rem;padding-top: ${paddingT}rem;;padding-bottom: ${paddingB}rem;`, 0)}><img${add_attribute("src", `${API_URL2}${values[0].url}`, 0)}${add_attribute("alt", values[0].substitution, 0)} class="${escape$4(null_to_empty(`figure-img m-0 p-0 ${rounded} ${shadow}`)) + " svelte-1hstmha"}">
                        <figcaption class="${"figure-caption"}">${escape$4(values[0].caption)}</figcaption></figure></a>` : `<figure class="${"figure"}"${add_attribute("style", `transform: rotate(${transformR}deg) scale(${scaleXY});margin-left: ${marginL}rem;;margin-right: ${marginR}rem;margin-top: ${marginT}rem;;margin-bottom: ${marginB}rem;padding-left: ${paddingL}rem;;padding-right: ${paddingR}rem;padding-top: ${paddingT}rem;;padding-bottom: ${paddingB}rem;`, 0)}><img${add_attribute("src", `${API_URL2}${values[0].url}`, 0)}${add_attribute("alt", values[0].substitution, 0)} class="${escape$4(null_to_empty(`figure-img m-0 p-0 ${rounded} ${shadow}`)) + " svelte-1hstmha"}">
                    <figcaption class="${"figure-caption"}">${escape$4(values[0].caption)}</figcaption></figure>`}</div></div>

    ${admin ? `<div class="${"middle svelte-1hstmha"}">${validate_component(EditButton, "EditButton").$$render($$result, { admin, updateContent, edit: edit2 }, {
      edit: ($$value) => {
        edit2 = $$value;
        $$settled = false;
      }
...
const TextBgFillPrimaryMarkdown = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<span class="${"bg-primary px-3 py-2 rounded-3"}">${slots.default ? slots.default({}) : ``}</span>`;
});
  ...
  do {
    ...
    $$rendered = `<div class="${"content-container svelte-14jnuhk"}">${validate_component(Modal, "Modal").$$render($$result, {
      ...
      default: () => `${validate_component(ModalHeader, "ModalHeader").$$render($$result, { toggle }, {}, { default: () => `Ajouter un contenu` })}
        ${validate_component(ModalBody, "ModalBody").$$render($$result, {}, {}, {
        default: () => `<div class="${"row"}"><div class="${"col"}"><textarea name="${"textarea"}" id="${"input-textarea"}" class="${"my-3 form-control"}"${add_attribute("rows", 6, 0)}>${values[0].value || ""}</textarea>
                    <div class="${"row py-1"}"><div class="${"col"}"><button class="${escape$4(null_to_empty(`px-1 btn ${textAlign === "start" ? "btn-primary" : "btn-light"}`)) + " svelte-14jnuhk"}">${validate_component(Icon, "Icon").$$render($$result, { name: "text-left" }, {}, {})}</button>
                        <button class="${escape$4(null_to_empty(`px-1 btn ${textAlign === "center" ? "btn-primary" : "btn-light"}`)) + " svelte-14jnuhk"}">${validate_component(Icon, "Icon").$$render($$result, { name: "text-center" }, {}, {})}</button>
                        <button class="${escape$4(null_to_empty(`px-1 btn ${textAlign === "justify" ? "btn-primary" : "btn-light"}`)) + " svelte-14jnuhk"}">${validate_component(Icon, "Icon").$$render($$result, { name: "justify-left" }, {}, {})}</button>
                        <button class="${escape$4(null_to_empty(`px-1 btn ${textAlign === "end" ? "btn-primary" : "btn-light"}`)) + " svelte-14jnuhk"}">${validate_component(Icon, "Icon").$$render($$result, { name: "text-right" }, {}, {})}</button></div></div>
          ...
          class: `text-${color}`
                    ...
                    <div class="${"row py-1"}"><div class="${"col"}"><span>Padding Left : </span>
                        ...
                        <div class="${"col"}"><span>Padding Bottom : </span>
                            <input type="${"number"}"${add_attribute("step", 1, 0)}${add_attribute("min", 0, 0)} class="${"form-control"}"${add_attribute("value", paddingB, 0)}></div></div>
                    <div class="${"row py-1"}"><div class="${"col"}"><span>Bordure arrondie : </span>
                            <button class="${escape$4(null_to_empty(`btn px-1 rounded-0 ${rounded === "rounded-0" ? "btn-primary" : "btn-light"}`)) + " svelte-14jnuhk"}"><span>r-0</span></button>
                            <button class="${escape$4(null_to_empty(`btn px-1 rounded-1 ${rounded === "rounded-1" ? "btn-primary" : "btn-light"}`)) + " svelte-14jnuhk"}"><span>r-1</span></button>
                            <button class="${escape$4(null_to_empty(`btn px-1 rounded-2 ${rounded === "rounded-2" ? "btn-primary" : "btn-light"}`)) + " svelte-14jnuhk"}"><span>r-2</span></button>
                            <button class="${escape$4(null_to_empty(`btn px-1 rounded-3 ${rounded === "rounded-3" ? "btn-primary" : "btn-light"}`)) + " svelte-14jnuhk"}"><span>r-3</span></button></div></div>
                    <div class="${"row py-1 align-items-center"}"><div class="${"col-4"}">Rotate : </div>
                        <div class="${"col-8"}"><input type="${"number"}" class="${"px-1 form-control"}"${add_attribute("value", transformR, 0)}></div></div>
                    <p class="${"my-3"}"><strong>Pr\xE9visualisation</strong></p>
                    <div class="${"row"}"><div class="${"col"}"><div class="${escape$4(null_to_empty(`${textColor} ${bgColor} ${rounded}`)) + " svelte-14jnuhk"}"${add_attribute("style", `text-align: ${textAlign};font-weight: ${fontWeight};font-style: ${fontStyle};transform: rotate(${transformR}deg);margin-left: ${marginL}rem;margin-right: ${marginR}rem;margin-top: ${marginT}rem;margin-bottom: ${marginB}rem;padding-left: ${paddingL}rem;padding-right: ${paddingR}rem;padding-top: ${paddingT}rem;padding-bottom: ${paddingB}rem;`, 0)}>${validate_component(SvelteMarkdown, "SvelteMarkdown").$$render($$result, {
...
const API_URL$1 = config.API_URL_PROD;
...
const AddElement = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let $copyComponent, $$unsubscribe_copyComponent;
  $$unsubscribe_copyComponent = subscribe(copyComponent, (value) => $copyComponent = value);
  let { addContent = null } = $$props;
  let { position = 0 } = $$props;
  let { addToLayout = null } = $$props;
  let { open = false } = $$props;
  let { copyValues = [] } = $$props;
  let { copyStyles = [] } = $$props;
  let { copyType = "" } = $$props;
  let type = "";
  let values = [];
  let styles = [];
  ...
  if ($$props.open === void 0 && $$bindings.open && open !== void 0)
    $$bindings.open(open);
  if ($$props.copyValues === void 0 && $$bindings.copyValues && copyValues !== void 0)
    $$bindings.copyValues(copyValues);
  if ($$props.copyStyles === void 0 && $$bindings.copyStyles && copyStyles !== void 0)
    $$bindings.copyStyles(copyStyles);
  if ($$props.copyType === void 0 && $$bindings.copyType && copyType !== void 0)
    $$bindings.copyType(copyType);
  $$unsubscribe_copyComponent();
  return `${validate_component(Modal, "Modal").$$render($$result, {
    ...
    ${validate_component(ModalBody, "ModalBody").$$render($$result, {}, {}, {
      default: () => `${validate_component(Row, "Row").$$render($$result, {}, {}, {
        default: () => `${validate_component(Col, "Col").$$render($$result, {}, {}, {
          default: () => `${validate_component(FormGroup, "FormGroup").$$render($$result, {}, {}, {
            default: () => `${$copyComponent ? `<div class="${"form-check form-switch mt-3"}"><input class="${"form-check-input"}" type="${"checkbox"}" id="${"flexSwitchPast"}" ${past ? "checked" : ""}>
                <label class="${"form-check-label"}" for="${"flexSwitchPast"}">Coller la forme en cache</label></div>` : ``}
            <div class="${"form-check form-switch mt-3"}"><input class="${"form-check-input"}" type="${"checkbox"}" id="${"flexSwitchCopy"}" ${copy ? "checked" : ""}>
              <label class="${"form-check-label"}" for="${"flexSwitchCopy"}">Copier la forme</label></div>
            ${!past ? `${validate_component(Label, "Label").$$render($$result, { for: "exampleSelect" }, {}, { default: () => `Select` })}
              <select class="${"form-select"}" type="${"select"}" name="${"select"}" id="${"exampleSelect"}"><option value="${""}" ${"selected"}>--- select ---</option><option value="${"layoutComponent"}" ${""}>type LAYOUT</option><option value="${"textComponent"}" ${""}>type TEXT</option><option value="${"imageComponent"}" ${""}>type IMAGE</option><option value="${"videoComponent"}" ${""}>type VIDEO</option><option value="${"compressComponent"}" ${""}>type COMPRESS FILE</option><option value="${"contactComponent"}" ${""}>type CONTACT</option><option value="${"sousligneComponent"}" ${""}>type TRAIT</option><option value="${"carouselComponent"}" ${""}>type CAROUSEL</option><option value="${"editoComponent"}" ${""}>type EDITO</option><option value="${"articlesComponent"}" ${""}>type ARTICLES</option><option value="${"partenairesComponent"}" ${""}>type PARTENAIRES</option><option value="${"infoComponent"}" ${""}>type INFO VILLE</option><option value="${"programmationComponent"}" ${""}>type PROGRAMMATION VILLE</option><option value="${"equipeComponent"}" ${""}>type EQUIPE</option></select>` : ``}`
          })}`
        })}`
      })}`
    })}
...
const MovingContent = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    <div class="${"moving-container border-light rounded-3 my-1 mx-1 p-1 bg-transparent shadow-lg svelte-13zd342"}"><div class="${"row align-items-center"}"><div class="${"col"}">${slots.default ? slots.default({}) : ``}</div>
            <div class="${"edition text-center svelte-13zd342"}"><div class="${"d-grid gap-2"}">${addContent ? `<button class="${"btn btn-primary btn-sm"}" data-bs-toggle="${"tooltip"}" data-bs-placement="${"left"}" title="${"Ajouter au dessus"}"><i class="${"bi bi-plus-circle-dotted"}"></i></button>` : ``}
                    <button class="${"btn btn-secondary btn-sm"}" data-bs-toggle="${"tooltip"}" data-bs-placement="${"left"}" title="${"D\xE9placer vers le haut"}"><i class="${"bi bi-caret-up"}"></i></button>
                    <span class="${"d-flex gap-2"}"><button class="${"btn btn-danger btn-sm"}" data-bs-toggle="${"tooltip"}" data-bs-placement="${"left"}" title="${"Supprimer"}"><i class="${"bi bi-trash"}"></i></button>
                        <button class="${"btn btn-info btn-sm"}" data-bs-toggle="${"tooltip"}" data-bs-placement="${"left"}" title="${"Copier"}"><i class="${"bi bi-files"}"></i></button></span>
                    <button class="${"btn btn-secondary btn-sm"}" data-bs-toggle="${"tooltip"}" data-bs-placement="${"left"}" title="${"D\xE9placer vers le bas"}"><i class="${"bi bi-caret-down"}"></i></button>
                    ${addContent ? `<button class="${"btn btn-primary btn-sm"}" data-bs-toggle="${"tooltip"}" data-bs-placement="${"left"}" title="${"Ajouter en dessous"}"><i class="${"bi bi-plus-circle-dotted"}"></i></button>` : ``}</div></div></div></div>` : `<span>${slots.default ? slots.default({}) : ``}</span>`}`;
  } while (!$$settled);
  return $$rendered;
});
const SeoComponent = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.updateContent === void 0 && $$bindings.updateContent && updateContent !== void 0)
    $$bindings.updateContent(updateContent);
  return `${$$result.head += `${$$result.title = `<title>${escape$4(`${pageContent && pageContent.titleSeo ? pageContent.titleSeo : defaultTitleSeo}`)}</title>`, ""}<meta name="${"description"}"${add_attribute("content", `${pageContent && pageContent.descriptionSeo ? pageContent.descriptionSeo : defaultDescriptionSeo}`, 0)} data-svelte="svelte-156jgom"><meta property="${"og:title"}"${add_attribute("content", `${pageContent && pageContent.titleOG ? pageContent.titleOG : defaultTitleOG}`, 0)} data-svelte="svelte-156jgom"><meta property="${"og:description"}"${add_attribute("content", `${pageContent && pageContent.descriptionOG ? pageContent.descriptionOG : defaultDescriptionOG}`, 0)} data-svelte="svelte-156jgom"><meta property="${"og:type"}" content="${"website"}" data-svelte="svelte-156jgom"><meta property="${"og:image"}"${add_attribute("content", `${siteURL}${defaultImageOG}`, 0)} data-svelte="svelte-156jgom"><meta property="${"og:image:width"}" content="${"800"}" data-svelte="svelte-156jgom"><meta property="${"og:image:height"}" content="${"400"}" data-svelte="svelte-156jgom"><meta property="${"og:url"}"${add_attribute("content", `${siteURL}${page2.path}`, 0)} data-svelte="svelte-156jgom"><meta property="${"og:locale"}" content="${"fr_FR"}" data-svelte="svelte-156jgom"><meta name="${"twitter:image"}"${add_attribute("content", `${siteURL}${defaultImageOG}`, 0)} data-svelte="svelte-156jgom"><meta name="${"twitter:card"}" content="${"summary_large_image"}" data-svelte="svelte-156jgom"><meta name="${"twitter:description"}"${add_attribute("content", `${pageContent && pageContent.descriptionOG ? pageContent.descriptionOG : defaultDescriptionOG}`, 0)} data-svelte="svelte-156jgom">`, ""}

${validate_component(CustomContainer, "CustomContainer").$$render($$result, { size: { xs: 12, sm: 8, md: 8, lg: 8 } }, {}, {
    default: () => `${admin && pageContent ? `<label for="${"seo-title"}" class="${"mt-5"}">Balise &quot;title&quot; pour le SEO</label>
...
async function load$1({ page: page2, fetch: fetch2, session, context }) {
  ...
  if (redirection.length === 1) {
    return {
      status: 200,
      props: { filmRequest: filmRequest2, id, page: page2 }
    };
  } else {
    return {
      status: 307,
      redirect: `/login?redirection=${redirection[0]}`
    };
  }
}
let edit = false;
const U5Bidu5D = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  const SITE_URL = config.SITE_URL_PROD;
...
${filmRequest2.film ? `${isAuthenticate ? `${validate_component(AdminButton, "AdminButton").$$render($$result, { isAuthenticate, admin }, {
    ...
    ${filmRequest2.film ? `${validate_component(CustomContainer, "CustomContainer").$$render($$result, {
      size: { xs: 12, sm: 12, md: 12, lg: 12, xl: 10 }
    }, {}, {
      default: () => `<div class="${"row mt-2 gx-3 gy-5"}">
                <div class="${"col-sm-12 col-md-4"}">${validate_component(ImageComponent, "ImageComponent").$$render($$result, {
        admin,
        edit,
        updateContent: updateFilm,
        ...
        styles: ($$value) => {
          ...
          $$settled = false;
                ...
                <div class="${"col-sm-12 col-md-8"}"><div class="${"row"}"><div class="${"col"}">${validate_component(TextComponent, "TextComponent").$$render($$result, {
        admin,
        edit,
        updateContent: updateFilm,
        ...
        styles: ($$value) => {
          ...
          $$settled = false;
                    ...
                    <div class="${"row mt-1"}"><div class="${"col-12"}">${validate_component(TextComponent, "TextComponent").$$render($$result, {
        admin,
        edit,
        updateContent: updateFilm,
        ...
        styles: ($$value) => {
          ...
          $$settled = false;
            ...
            <div class="${"row mt-4 align-items-center"}"><div class="${"col-12"}">${validate_component(TextComponent, "TextComponent").$$render($$result, {
        admin,
        edit,
        updateContent: updateFilm,
...
const API_URL = config.API_URL_PROD;
...
${validate_component(Row, "Row").$$render($$result, { class: "my-1 py-1" }, {}, {
      default: () => `${validate_component(Col, "Col").$$render($$result, {}, {}, {
        default: () => `${validate_component(Button, "Button").$$render($$result, { color: "primary", class: "my-1 p-2" }, {}, { default: () => `Ajouter un contenu` })}`
      })}`
    })}`;
  } while (!$$settled);
  return $$rendered;
...
var PartenairesComponent_svelte_svelte_type_style_lang = ".edition.svelte-1dwm0ze.svelte-1dwm0ze{-webkit-transform:scale(0);transform:scale(0);transition:.5s ease;width:0px}.moving-container.svelte-1dwm0ze:hover .edition.svelte-1dwm0ze{-webkit-transform:scale(1);transform:scale(1);transition:.5s ease;width:25vh}";
const css$6 = {
  code: ".edition.svelte-1dwm0ze.svelte-1dwm0ze{-webkit-transform:scale(0);transform:scale(0);transition:.5s ease;width:0px}.moving-container.svelte-1dwm0ze:hover .edition.svelte-1dwm0ze{-webkit-transform:scale(1);transform:scale(1);transition:.5s ease;width:25vh}",
  map: `{"version":3,"file":"PartenairesComponent.svelte","sources":["PartenairesComponent.svelte"],"sourcesContent":["<script>\\n    import ImageComponent from \\"./ImageComponent.svelte\\";\\n    import MovingContent from \\"./MovingContent.svelte\\";\\n    import TextComponent from \\"./TextComponent.svelte\\";\\n\\n    export let values=[];\\n    export let styles=[];\\n    export let admin='false';\\n    export let edit='false';\\n    export let updateContent;\\n\\n    styles;\\n\\n$: {\\n    if (values.length < 2) {\\n        values.push({name:'category', values:[], styles:[]});\\n        values.push({name:'partenaires', values:[{ \\n            name: {name:'Partenaire name', values:[], styles:[]},\\n            url: {name: 'Partenaire image', values:[], styles:[]}\\n        }]});\\n    }\\n}\\n\\nconst addPartnerHandler = () => {\\n    values[1].values.push({ \\n        name: {name:'Partenaire name', values:[], styles:[]},\\n        url: {name: 'Partenaire image', values:[], styles:[]}\\n    });\\n    values = values;\\n};\\n\\nconst updateMovedArray = async(array) => {\\n    values[1].values = array;\\n    values = values;\\n    updateContent();\\n};\\n\\n<\/script>\\n\\n\\n\\n<!-- categorie de partenaire -->\\n<div class='row mt-5'>\\n    <div class=\\"col\\">\\n        <TextComponent\\n            bind:values={values[0].values}\\n            bind:styles={values[0].styles}\\n            admin={admin}\\n            edit={edit}\\n            updateContent={updateContent}\\n        />\\n    </div>\\n</div>\\n\\n<!-- affichage des partenaire -->\\n<div class='moving-container row pt-3 gx-3 align-items-center'>\\n    {#each values[1].values as partenaire, position}\\n        <div class='col-6 col-md-3 text-center'>\\n            <MovingContent \\n                array={values[1].values} \\n                position={position} \\n                admin={admin} \\n                updateMovedArray={updateMovedArray}\\n            >\\n                <div class='my-2'>\\n                    <ImageComponent \\n                        bind:values={partenaire.url.values}\\n                        bind:styles={partenaire.url.styles}\\n                        edit={edit}\\n                        admin={admin}\\n                        updateContent={updateContent}\\n                    />\\n                    <TextComponent\\n                        bind:values={partenaire.name.values}\\n                        bind:styles={partenaire.name.styles}\\n                        edit={edit}\\n                        admin={admin}\\n                        updateContent={updateContent}\\n                    />    \\n                </div>    \\n            </MovingContent>\\n        </div>   \\n    {/each}\\n    <!-- on admin mode -->\\n    {#if admin}\\n    <!-- <div class='row my-5'> -->\\n        <div class='edition add-partenaire col-sm-6 col-md-3 text-center border-light rounded-3 mt-3 mb-1 p-3 bg-lavande shadow-lg'>\\n            <button class='btn btn-primary py-auto' on:click={addPartnerHandler}>Add a partner</button>\\n        </div>\\n    <!-- </div> -->\\n    {/if}\\n</div>\\n\\n<style>\\n    .edition {\\n        -webkit-transform: scale(0);\\n\\t    transform: scale(0);\\n        transition: .5s ease;\\n        width: 0px;\\n    }\\n    .moving-container:hover .edition {\\n        -webkit-transform: scale(1);\\n\\t    transform: scale(1);\\n        transition: .5s ease;\\n        width: 25vh;\\n    }\\n</style>"],"names":[],"mappings":"AA8FI,QAAQ,8BAAC,CAAC,AACN,iBAAiB,CAAE,MAAM,CAAC,CAAC,CAC9B,SAAS,CAAE,MAAM,CAAC,CAAC,CAChB,UAAU,CAAE,GAAG,CAAC,IAAI,CACpB,KAAK,CAAE,GAAG,AACd,CAAC,AACD,gCAAiB,MAAM,CAAC,QAAQ,eAAC,CAAC,AAC9B,iBAAiB,CAAE,MAAM,CAAC,CAAC,CAC9B,SAAS,CAAE,MAAM,CAAC,CAAC,CAChB,UAAU,CAAE,GAAG,CAAC,IAAI,CACpB,KAAK,CAAE,IAAI,AACf,CAAC"}`
};
...
<div class="${"moving-container row pt-3 gx-3 align-items-center svelte-1dwm0ze"}">${each(values[1].values, (partenaire, position) => `<div class="${"col-6 col-md-3 text-center"}">${validate_component(MovingContent, "MovingContent").$$render($$result, {
      array: values[1].values,
      position,
      admin,
      updateMovedArray
    ...
    ${admin ? `
        <div class="${"edition add-partenaire col-sm-6 col-md-3 text-center border-light rounded-3 mt-3 mb-1 p-3 bg-lavande shadow-lg svelte-1dwm0ze"}"><button class="${"btn btn-primary py-auto"}">Add a partner</button></div>
    ` : ``}
</div>`;
  } while (!$$settled);
  return $$rendered;
...
${validate_component(CustomContainer, "CustomContainer").$$render($$result, {}, {}, {
      default: () => `<div class="${"row mt-3 mb-5 gx-5 gy-3"}">${each(values[0].values, (lieu, position) => `
...
var ProgrammationComponent_svelte_svelte_type_style_lang = ".image-container.svelte-1bd9cvk.svelte-1bd9cvk{position:relative;min-height:2vh}.image.svelte-1bd9cvk.svelte-1bd9cvk{opacity:1;backface-visibility:hidden;max-width:100%;height:auto}.middle.svelte-1bd9cvk.svelte-1bd9cvk{transition:.5s ease;opacity:1;position:absolute;top:50%;left:50%;height:100%;width:100%;transform:translate(-50%, -50%);-ms-transform:translate(-50%, -50%);text-align:center;cursor:pointer}.event-container.svelte-1bd9cvk.svelte-1bd9cvk{-webkit-transform:scale(1);transform:scale(1);transition:.5s ease}.event-container.svelte-1bd9cvk:hover .middle.svelte-1bd9cvk{opacity:1}.film.svelte-1bd9cvk.svelte-1bd9cvk{position:absolute;top:55%;width:100%}.debat.svelte-1bd9cvk.svelte-1bd9cvk{position:absolute;top:65%;width:100%}.info.svelte-1bd9cvk.svelte-1bd9cvk{position:absolute;top:88%;left:5%;width:90%;height:10%}";
const css$4 = {
  code: ".image-container.svelte-1bd9cvk.svelte-1bd9cvk{position:relative;min-height:2vh}.image.svelte-1bd9cvk.svelte-1bd9cvk{opacity:1;backface-visibility:hidden;max-width:100%;height:auto}.middle.svelte-1bd9cvk.svelte-1bd9cvk{transition:.5s ease;opacity:1;position:absolute;top:50%;left:50%;height:100%;width:100%;transform:translate(-50%, -50%);-ms-transform:translate(-50%, -50%);text-align:center;cursor:pointer}.event-container.svelte-1bd9cvk.svelte-1bd9cvk{-webkit-transform:scale(1);transform:scale(1);transition:.5s ease}.event-container.svelte-1bd9cvk:hover .middle.svelte-1bd9cvk{opacity:1}.film.svelte-1bd9cvk.svelte-1bd9cvk{position:absolute;top:55%;width:100%}.debat.svelte-1bd9cvk.svelte-1bd9cvk{position:absolute;top:65%;width:100%}.info.svelte-1bd9cvk.svelte-1bd9cvk{position:absolute;top:88%;left:5%;width:90%;height:10%}",
  map: `{"version":3,"file":"ProgrammationComponent.svelte","sources":["ProgrammationComponent.svelte"],"sourcesContent":["<script>\\n    import { goto } from \\"$app/navigation\\";\\n\\n    import { createFilmRequest } from \\"../actions/filmActions\\";\\n\\n    import ImageComponent from \\"./ImageComponent.svelte\\";\\n    import MovingContent from \\"./MovingContent.svelte\\";\\n    import TextComponent from \\"./TextComponent.svelte\\";\\n    export let values=[];\\n    export let styles=[];\\n    export let admin='false';\\n    export let edit='false';\\n    export let updateContent;\\n    export let city='';\\n\\n    styles;\\n\\n    $:{\\n        if (values.length === 0 ) {\\n            values.push({date: ''});\\n        }\\n    }\\n\\n    const updateMovedArray = async(array) => {\\n        values[1].values = array;\\n        values = values;\\n        updateContent && updateContent();\\n    };\\n\\n    const addEventHandler = async () => {\\n        if (values.length === 1) {\\n            values.push({values: []});\\n        }\\n        if (!values[1].values) {\\n            console.log(values);\\n        }\\n        const filmCreatedId = await createFilmRequest(city);\\n\\n        values[1].values.push({ \\n            //date: {name:'date', values:[], styles:[]},\\n            url: {name: 'image', values:[], styles:[]},\\n            film: {name: 'film', values:[], styles:[]},\\n            debat: {name: 'debat', values:[], styles:[]},\\n            horaire: {name: 'horaire', values:[], styles:[]},\\n            filmId: filmCreatedId,\\n        });\\n        //values = values;\\n        updateContent && updateContent();\\n    };\\n\\n<\/script>\\n\\n<div class='row mt-2 px-4'>\\n    {#if values[1] && values[1].values}\\n        {#each values[1].values as evenement, position }\\n            <div class='col-12 my-4'>\\n                <MovingContent\\n                array={values[1].values} \\n                position={position} \\n                admin={admin} \\n                updateMovedArray={updateMovedArray}\\n                >\\n                <div class='horaire mb-3'>\\n                    <TextComponent\\n                    bind:values={evenement.horaire.values}\\n                    bind:styles={evenement.horaire.styles}\\n                    admin={admin}\\n                    edit={edit}\\n                    updateContent={updateContent}\\n                    />\\n                </div>\\n                <div class='bg-white rounded-3 event-container'>\\n                    <div class='image-container'>\\n                        <div class=\\"image my-auto\\">\\n                            <ImageComponent\\n                                bind:values={evenement.url.values}\\n                                bind:styles={evenement.url.styles}\\n                                admin={admin}\\n                                edit={edit}\\n                                updateContent={updateContent}\\n                            />\\n                            <div class={admin ? '' : 'middle'} on:click={() => {if(!admin) {goto(\`/film/\${evenement.filmId}\`)}}}>\\n                                <div class='film px-3'>\\n                                    <TextComponent\\n                                    bind:values={evenement.film.values}\\n                                    bind:styles={evenement.film.styles}\\n                                    admin={admin}\\n                                    edit={edit}\\n                                    updateContent={updateContent}\\n                                    />\\n                                </div>\\n                                <div class='debat px-3'>\\n                                    <TextComponent\\n                                    bind:values={evenement.debat.values}\\n                                    bind:styles={evenement.debat.styles}\\n                                    admin={admin}\\n                                    edit={edit}\\n                                    updateContent={updateContent}\\n                                    />\\n                                </div>\\n                                {#if !admin}\\n                                    <button class='info btn btn-dark mx-auto text-center text-light p-0 m-0 rounded-0' on:click={() => goto(\`/film/\${evenement.filmId}\`)}><strong>EN SAVOIR PLUS</strong></button>\\n                                {/if}\\n                            </div>\\n                        </div>\\n                    </div>\\n                </div>\\n                </MovingContent>\\n            </div>\\n        {/each}\\n    {/if}\\n    {#if admin && updateContent}\\n        <div class='row'>\\n            <div class='col text-center'>\\n                <button class='btn btn-primary text-center' on:click={addEventHandler}>Add Event</button>\\n            </div>\\n        </div>\\n    {/if}\\n</div>\\n\\n<style>\\n    .image-container {\\n        position: relative;\\n        min-height: 2vh;\\n    }\\n    .image {\\n        opacity: 1;\\n        backface-visibility: hidden;\\n        max-width: 100%;\\n        height:auto;\\n    }\\n    .middle {\\n        transition: .5s ease;\\n        opacity: 1;\\n        position: absolute;\\n        top: 50%;\\n        left: 50%;\\n        height: 100%;\\n        width: 100%;\\n        transform: translate(-50%, -50%);\\n        -ms-transform: translate(-50%, -50%);\\n        text-align: center;\\n        cursor: pointer;\\n    }\\n    .event-container {\\n        -webkit-transform: scale(1);\\n\\t    transform: scale(1);\\n        transition: .5s ease;\\n    }\\n    .event-container:hover .middle {\\n        opacity: 1;\\n    }\\n    /* .horaire {\\n        position: absolute;\\n        top: 12%;\\n        left: 17%;\\n    } */\\n    .film {\\n        position: absolute;\\n        top: 55%;\\n        width: 100%;\\n    }\\n    .debat {\\n        position: absolute;\\n        top: 65%;\\n        width: 100%;\\n    }\\n    .info {\\n        position: absolute;\\n        top: 88%;\\n        left: 5%;\\n        width: 90%;\\n        height: 10%;\\n    }\\n    \\n</style>"],"names":[],"mappings":"AAyHI,gBAAgB,8BAAC,CAAC,AACd,QAAQ,CAAE,QAAQ,CAClB,UAAU,CAAE,GAAG,AACnB,CAAC,AACD,MAAM,8BAAC,CAAC,AACJ,OAAO,CAAE,CAAC,CACV,mBAAmB,CAAE,MAAM,CAC3B,SAAS,CAAE,IAAI,CACf,OAAO,IAAI,AACf,CAAC,AACD,OAAO,8BAAC,CAAC,AACL,UAAU,CAAE,GAAG,CAAC,IAAI,CACpB,OAAO,CAAE,CAAC,CACV,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,GAAG,CACR,IAAI,CAAE,GAAG,CACT,MAAM,CAAE,IAAI,CACZ,KAAK,CAAE,IAAI,CACX,SAAS,CAAE,UAAU,IAAI,CAAC,CAAC,IAAI,CAAC,CAChC,aAAa,CAAE,UAAU,IAAI,CAAC,CAAC,IAAI,CAAC,CACpC,UAAU,CAAE,MAAM,CAClB,MAAM,CAAE,OAAO,AACnB,CAAC,AACD,gBAAgB,8BAAC,CAAC,AACd,iBAAiB,CAAE,MAAM,CAAC,CAAC,CAC9B,SAAS,CAAE,MAAM,CAAC,CAAC,CAChB,UAAU,CAAE,GAAG,CAAC,IAAI,AACxB,CAAC,AACD,+BAAgB,MAAM,CAAC,OAAO,eAAC,CAAC,AAC5B,OAAO,CAAE,CAAC,AACd,CAAC,AAMD,KAAK,8BAAC,CAAC,AACH,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,GAAG,CACR,KAAK,CAAE,IAAI,AACf,CAAC,AACD,MAAM,8BAAC,CAAC,AACJ,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,GAAG,CACR,KAAK,CAAE,IAAI,AACf,CAAC,AACD,KAAK,8BAAC,CAAC,AACH,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,GAAG,CACR,IAAI,CAAE,EAAE,CACR,KAAK,CAAE,GAAG,CACV,MAAM,CAAE,GAAG,AACf,CAAC"}`
};
const ProgrammationComponent = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `<div class="${"row mt-2 px-4"}">${values[1] && values[1].values ? `${each(values[1].values, (evenement, position) => `<div class="${"col-12 my-4"}">${validate_component(MovingContent, "MovingContent").$$render($$result, {
      array: values[1].values,
      position,
      admin,
      updateMovedArray
    }, {}, {
      default: () => `<div class="${"horaire mb-3"}">${validate_component(TextComponent, "TextComponent").$$render($$result, {
        admin,
        edit: edit2,
        updateContent,
        ...
        styles: ($$value) => {
          ...
          $$settled = false;
                ...
                <div class="${"bg-white rounded-3 event-container svelte-1bd9cvk"}"><div class="${"image-container svelte-1bd9cvk"}"><div class="${"image my-auto svelte-1bd9cvk"}">${validate_component(ImageComponent, "ImageComponent").$$render($$result, {
        admin,
        edit: edit2,
        updateContent,
        ...
        styles: ($$value) => {
          ...
          $$settled = false;
                            ...
                            <div class="${escape$4(null_to_empty(admin ? "" : "middle")) + " svelte-1bd9cvk"}"><div class="${"film px-3 svelte-1bd9cvk"}">${validate_component(TextComponent, "TextComponent").$$render($$result, {
        admin,
        edit: edit2,
        updateContent,
        ...
        styles: ($$value) => {
          ...
          $$settled = false;
                                ...
                                <div class="${"debat px-3 svelte-1bd9cvk"}">${validate_component(TextComponent, "TextComponent").$$render($$result, {
        admin,
        edit: edit2,
        updateContent,
        ...
        styles: ($$value) => {
          ...
          $$settled = false;
                                ...
                                ${!admin ? `<button class="${"info btn btn-dark mx-auto text-center text-light p-0 m-0 rounded-0 svelte-1bd9cvk"}"><strong>EN SAVOIR PLUS</strong></button>` : ``}
                            </div></div>
                    </div></div>
                `
    })}
...
const ContactForm = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `${validate_component(CustomContainer, "CustomContainer").$$render($$result, { size: { xs: 12, sm: 12, md: 12, lg: 8 } }, {}, {
      default: () => `<div class="${"mt-5"}"><div class="${"text-center my-3"}">${validate_component(TextComponent, "TextComponent").$$render($$result, {
        ...
        ${admin ? `<label for="${"type-of-contact"}">S\xE9lectionner le destinataire</label>
            <select class="${"form-control"}" name="${"type-of-contact"}" id="${"type-of-contact"}"><option value="${""}">--selectionner--</option><option value="${"contact"}">Contact</option><option value="${"dev"}">D\xE9veloppeur</option></select>` : ``}
    
        <form id="${"contact"}" class="${"row contact-form"}"><div class="${"row align-items-center mb-3"}"><div class="${"col-sm-12 col-md-6"}"><label for="${"exampleInputNom"}" class="${"form-label"}">Votre nom</label>
                    <input type="${"text"}" class="${"form-control"}" id="${"exampleInputNom"}" aria-describedby="${"nomHelp"}" placeholder="${"Votre nom"}" required${add_attribute("value", nom, 0)}>
                    </div>
                <div class="${"col-sm-12 col-md-6"}"><label for="${"exampleInputPrenom"}" class="${"form-label"}">Votre pr\xE9nom</label>
                    <input type="${"text"}" class="${"form-control"}" id="${"exampleInputPrenom"}" aria-describedby="${"emailHelp"}" placeholder="${"Votre pr\xE9nom"}" required${add_attribute("value", prenom, 0)}>
                    </div></div>
            <div class="${"row align-items-center mb-3"}"><div class="${"col-sm-12 col-md-6"}"><label for="${"exampleInputSujet"}" class="${"form-label"}">Sujet du message</label>
                    <input type="${"text"}" class="${"form-control"}" id="${"exampleInputSujet"}" aria-describedby="${"SujetHelp"}" placeholder="${"Votre sujet"}" required${add_attribute("value", subject, 0)}>
                    </div>
                <div class="${"col-sm-12 col-md-6"}"><label for="${"exampleInputEmail1"}" class="${"form-label"}">Votre adresse e-mail</label>
                    <input type="${"email"}" class="${"form-control"}" id="${"exampleInputEmail1"}" aria-describedby="${"emailHelp"}" placeholder="${"Votre e-mail"}" required${add_attribute("value", email, 0)}></div></div>
            ...
            <div class="${"row mb-3"}"><div class="${"col"}"><label for="${"emailBody"}" class="${"form-label"}">Votre message</label>
                    ...
                    <div id="${"bodyHelper"}" class="${"form-text"}">* champs obligatoires</div></div></div>
...
const LayoutComponent = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    border = styles.filter((x) => x.name === "border")[0] && styles.filter((x) => x.name === "border")[0].value;
    borderColor = styles.filter((x) => x.name === "border-color")[0] && styles.filter((x) => x.name === "border-color")[0].value;
    $$rendered = `${validate_component(CustomContainer, "CustomContainer").$$render($$result, {
      size: {
        xs: values[0].xs ? values[0].xs : 12,
        sm: values[0].sm ? values[0].sm : 10,
        md: values[0].md ? values[0].md : 10,
      ...
      default: () => `<div class="${"content-container svelte-1en7of8"}">${admin ? `<div class="${"middle svelte-1en7of8"}">${validate_component(EditButton, "EditButton").$$render($$result, { admin, updateContent, edit: edit2 }, {
        edit: ($$value) => {
          edit2 = $$value;
          $$settled = false;
        }
        ...
        default: () => `${validate_component(ModalHeader, "ModalHeader").$$render($$result, { toggle }, {}, { default: () => `Editer le layout` })}
            ${validate_component(ModalBody, "ModalBody").$$render($$result, {}, {}, {
          default: () => `<div class="${"row align-items-center my-2"}"><div class="${"col"}"><label for="${"input-columns"}" class="${"form-label"}">Nombre de colonnes</label>
                            ...
                            <div class="${"row my-3"}"><p>Largeur du layout en fonction de l&#39;\xE9cran</p>
                                <div class="${"col"}"><label for="${"xs-size"}">&quot;xs screen (Mobile) (/12)&quot;</label>
                                    <input type="${"number"}" class="${"form-control"}" id="${"xs-size"}"${add_attribute("min", 1, 0)}${add_attribute("max", 12, 0)}${add_attribute("value", values[0].xs, 0)}></div>
                                <div class="${"col"}"><label for="${"sm-size"}">&quot;sm screen (Tablette) (/12)&quot;</label>
                                    <input type="${"number"}" class="${"form-control"}" id="${"sm-size"}"${add_attribute("min", 1, 0)}${add_attribute("max", 12, 0)}${add_attribute("value", values[0].sm, 0)}></div>
                                <div class="${"col"}"><label for="${"md-size"}">&quot;md screen (Tablette) (/12)&quot;</label>
                                    <input type="${"number"}" class="${"form-control"}" id="${"md-size"}"${add_attribute("min", 1, 0)}${add_attribute("max", 12, 0)}${add_attribute("value", values[0].md, 0)}></div>
                                <div class="${"col"}"><label for="${"lg-size"}">&quot;lg screen (Desktop) (/12)&quot;</label>
                                    <input type="${"number"}" class="${"form-control"}" id="${"lg-size"}"${add_attribute("min", 1, 0)}${add_attribute("max", 12, 0)}${add_attribute("value", values[0].lg, 0)}></div>
                                <div class="${"col"}"><label for="${"xl-size"}">&quot;xl screen (Ecran large) (/12)&quot;</label>
                                    <input type="${"number"}" class="${"form-control"}" id="${"xl-size"}"${add_attribute("min", 1, 0)}${add_attribute("max", 12, 0)}${add_attribute("value", values[0].xl, 0)}></div></div>
                            <div class="${"row py-1 my-2"}"><div class="${"col"}"><span>Alignement : </span>
                                    <button class="${escape$4(null_to_empty(`px-1 btn ${alignContent === "start" ? "btn-primary" : "btn-light"}`)) + " svelte-1en7of8"}">${validate_component(Icon, "Icon").$$render($$result, { name: "align-top" }, {}, {})}</button>
                                    <button class="${escape$4(null_to_empty(`px-1 btn ${alignContent === "center" ? "btn-primary" : "btn-light"}`)) + " svelte-1en7of8"}">${validate_component(Icon, "Icon").$$render($$result, { name: "align-middle" }, {}, {})}</button>
                                    <button class="${escape$4(null_to_empty(`px-1 btn ${alignContent === "end" ? "btn-primary" : "btn-light"}`)) + " svelte-1en7of8"}">${validate_component(Icon, "Icon").$$render($$result, { name: "align-bottom" }, {}, {})}</button></div></div>
                            <div class="${"row py-1 my-2"}"><div class="${"col"}"><span>Fond : </span>
            ...
            class: `text-${color}`
                            ...
                            <div class="${"row py-1 my-2"}"><div class="${"col"}"><span>Margin X : </span>
                                    <input type="${"number"}"${add_attribute("step", 1, 0)}${add_attribute("min", 0, 0)} class="${"form-control"}"${add_attribute("value", marginX, 0)}></div>
                                <div class="${"col"}"><span>Margin Y : </span>
                                    <input type="${"number"}"${add_attribute("step", 1, 0)}${add_attribute("min", 0, 0)} class="${"form-control"}"${add_attribute("value", marginY, 0)}></div></div>
                            <div class="${"row py-1 my-2"}"><div class="${"col"}"><span>Padding X : </span>
                                    <input type="${"number"}"${add_attribute("step", 1, 0)}${add_attribute("min", 0, 0)} class="${"form-control"}"${add_attribute("value", paddingX, 0)}></div>
                                <div class="${"col"}"><span>Padding Y : </span>
                                    <input type="${"number"}"${add_attribute("step", 1, 0)}${add_attribute("min", 0, 0)} class="${"form-control"}"${add_attribute("value", paddingY, 0)}></div></div>
                            
                            <div class="${"row py-1 my-2"}"><div class="${"col"}"><span>Bordure arrondie : </span>
                                    <button class="${escape$4(null_to_empty(`btn px-1 rounded-0 ${rounded === "rounded-0" ? "btn-primary" : "btn-light"}`)) + " svelte-1en7of8"}"><span>r-0</span></button>
                                    <button class="${escape$4(null_to_empty(`btn px-1 rounded-1 ${rounded === "rounded-1" ? "btn-primary" : "btn-light"}`)) + " svelte-1en7of8"}"><span>r-1</span></button>
                                    <button class="${escape$4(null_to_empty(`btn px-1 rounded-2 ${rounded === "rounded-2" ? "btn-primary" : "btn-light"}`)) + " svelte-1en7of8"}"><span>r-2</span></button>
                                    <button class="${escape$4(null_to_empty(`btn px-1 rounded-3 ${rounded === "rounded-3" ? "btn-primary" : "btn-light"}`)) + " svelte-1en7of8"}"><span>r-3</span></button></div></div>
                            <div class="${"row py-1 my-2"}"><div class="${"col"}"><span>Couleur de la bordure : </span>
                                    ${each(colors, (color) => `<button class="${"px-1 btn btn-light"}">${validate_component(Icon, "Icon").$$render($$result, {
            name: "border-outer",
            class: `text-${color}`
          }, {}, {})}
                    ...
                    <p class="${"my-3"}"><strong>Pr\xE9visualisation</strong></p>
                    <div class="${escape$4(null_to_empty(`row gx-2 gy-2 align-items-${alignContent} ${bgColor} ${marginX} ${marginY} ${rounded} ${border} ${borderColor}`)) + " svelte-1en7of8"}"${add_attribute("style", `margin-left: ${marginX}rem;margin-right: ${marginX}rem;margin-bottom: ${marginY}rem;margin-top: ${marginY}rem;padding-left: ${paddingX}rem;padding-right: ${paddingX}rem;padding-top: ${paddingY}rem;padding-bottom: ${paddingY}rem;`, 0)}>${each(values, (column, position) => `<div class="${escape$4(null_to_empty(`col-sm-${sm.toString()} col-md-${md.toString()} border border-light`)) + " svelte-1en7of8"}" style="${escape$4(`min-height: 5vh;`) + ";"}">Colonne ${escape$4(position)}                                
                            </div>`)}</div>`
        })}
            ${validate_component(ModalFooter, "ModalFooter").$$render($$result, {}, {}, {
          default: () => `<button class="${"btn btn-primary"}">Enregistrer</button>
        ...
        <div class="${escape$4(null_to_empty(`row gx-2 gy-2 content align-items-${alignContent} ${bgColor} ${marginX} ${marginY} ${rounded} ${border} ${borderColor}`)) + " svelte-1en7of8"}"${add_attribute("style", `margin-left: ${marginX}rem;margin-right: ${marginX}rem;margin-bottom: ${marginY}rem;margin-top: ${marginY}rem;padding-left: ${paddingX}rem;padding-right: ${paddingX}rem;padding-top: ${paddingY}rem;padding-bottom: ${paddingY}rem;`, 0)}>${each(values, (column, position) => `
                <div class="${escape$4(null_to_empty(`col-${calculateCol(column.sizeMobile, position, values.length)} col-md-${calculateCol(column.sizeTablette, position, values.length)} col-xl-${calculateCol(column.size, position, values.length)}`)) + " svelte-1en7of8"}" style="${escape$4(`min-height: 5vh;`) + ";"}">${validate_component(MovingContent, "MovingContent").$$render($$result, {
        array: values,
        position,
        admin,
        updateMovedArray,
        ...
        default: () => `${admin ? `<div class="${"row"}"><div class="${"col"}"><label for="${"conf-desktop-size"}">Largeur (/12) PC</label>
                                <input id="${"conf-desktop-size"}" class="${"form-control"}" type="${"number"}"${add_attribute("min", 1, 0)}${add_attribute("max", 12, 0)}${add_attribute("value", column.size, 0)}></div>
                            <div class="${"col"}"><label for="${"conf-mobile-size"}">Largeur (/12) Tablette</label>
                                <input id="${"conf-mobile-size"}" class="${"form-control"}" type="${"number"}"${add_attribute("min", 1, 0)}${add_attribute("max", 12, 0)}${add_attribute("value", column.sizeTablette, 0)}></div>
                            <div class="${"col"}"><label for="${"conf-mobile-size"}">Largeur (/12) Mobile</label>
                                <input id="${"conf-mobile-size"}" class="${"form-control"}" type="${"number"}"${add_attribute("min", 1, 0)}${add_attribute("max", 12, 0)}${add_attribute("value", column.sizeMobile, 0)}>
                            </div></div>
                        <p>${escape$4("* somme de la ligne < 12")}</p>` : ``}
                    
                    ${each(column.values, (content, pos) => `${validate_component(MovingContent, "MovingContent").$$render($$result, {
          array: column.values,
          position: pos,
          admin,
          updateMovedArray: async (array) => {
          ...
          default: () => `${validate_component(DisplayCustomComponent, "DisplayCustomComponent").$$render($$result, {
            ...
            styles: ($$value) => {
              ...
              $$settled = false;
                    ...
                    ${admin ? `
                        <div class="${"moving-container border-light rounded-3 my-1 py-1 px-3 bg-transparent shadow-lg text-center svelte-1en7of8"}">${validate_component(AddContent, "AddContent").$$render($$result, { admin, position, addToLayout }, {}, {})}
                        </div>` : ``}
...
const SouslligneComponent = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    textAlign = styles.filter((x) => x.name === "text-align")[0] && styles.filter((x) => x.name === "text-align")[0].value;
    textColor = styles.filter((x) => x.name === "text-color")[0] && styles.filter((x) => x.name === "text-color")[0].value;
    $$rendered = `<div class="${"content-container row svelte-1e1156t"}"><div class="${"col"}"><div class="${escape$4(null_to_empty(`border-top border-5 ${textColor}`)) + " svelte-1e1156t"}"${add_attribute("style", `max-width: ${width}vh; margin-top:${marginTop}px;margin-bottom:${marginBottom}px;${textAlign}`, 0)}></div>
        ${admin ? `<div class="${"middle svelte-1e1156t"}">${validate_component(EditButton, "EditButton").$$render($$result, { admin, updateContent, edit: edit2 }, {
      edit: ($$value) => {
        edit2 = $$value;
        $$settled = false;
      }
    ...
    ${edit2 ? `<div class="${"parametres svelte-1e1156t"}"><label for="${"inputWidth"}">Largeur en % de la largeur totale</label>
            <input id="${"inputWidth"}" type="${"number"}" class="${"form-control"}"${add_attribute("value", width, 0)}>
            <label for="${"marginTop"}">Marge au dessus en pixels</label>
            <input id="${"marginTop"}" type="${"number"}" class="${"form-control"}"${add_attribute("value", marginTop, 0)}${add_attribute("min", 0, 0)}>
            <label for="${"marginBottom"}">Marge au dessous en pixels</label>
            <input id="${"marginBottom"}" type="${"number"}" class="${"form-control"}"${add_attribute("value", marginBottom, 0)}${add_attribute("min", 0, 0)}>
            <div class="${"py-1"}"><div class="${""}"><button class="${"px-1 btn btn-light"}">${validate_component(Icon, "Icon").$$render($$result, { name: "text-left" }, {}, {})}</button>
                <button class="${"px-1 btn btn-light"}">${validate_component(Icon, "Icon").$$render($$result, { name: "text-center" }, {}, {})}</button>
                <button class="${"px-1 btn btn-light"}">${validate_component(Icon, "Icon").$$render($$result, { name: "text-right" }, {}, {})}</button></div></div>
            <div class="${"py-1"}"><div class="${""}">${each(colors, (color) => `<btn class="${"px-1 btn btn-light"}">${validate_component(Icon, "Icon").$$render($$result, { name: "fonts", class: `text-${color}` }, {}, {})}</btn>`)}</div></div></div>` : ``}
</div>`;
  } while (!$$settled);
  return $$rendered;
});
var CompressFileComponent_svelte_svelte_type_style_lang = ".content-container.svelte-2sm8o1.svelte-2sm8o1{position:relative}.middle.svelte-2sm8o1.svelte-2sm8o1{transition:.5s ease;opacity:0.7;position:absolute;top:50%;left:50%;transform:translate(-50%, -50%);-ms-transform:translate(-50%, -50%);text-align:center}.content-container.svelte-2sm8o1:hover .middle.svelte-2sm8o1{opacity:1}";
const css$1 = {
...
const CompressFileComponent = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `${validate_component(Modal, "Modal").$$render($$result, {
      ...
      default: () => `${validate_component(ModalHeader, "ModalHeader").$$render($$result, { toggle }, {}, { default: () => `Ajouter un contenu` })}
    ${validate_component(ModalBody, "ModalBody").$$render($$result, {}, {}, {
        default: () => `<div class="${"row"}"><div class="${"col"}"><div class="${"mb-3"}"><label for="${"formFile"}" class="${"form-label"}">Importer un fichier compress\xE9 (.zip .7z .tar)</label>
                    <input class="${"form-control"}" type="${"file"}" id="${"formFile"}"></div>
                <div class="${"row py-1"}"><div class="${"col"}"><p>Couleur du bouton de t\xE9l\xE9chargement</p>
                    ${each(colors, (color) => `<btn class="${"px-1 btn btn-light"}">${validate_component(Icon, "Icon").$$render($$result, { name: "fonts", class: `text-${color}` }, {}, {})}</btn>`)}</div></div>
                <div class="${"row py-1"}"><div class="${"col"}"><p>Aligne du boutton</p>
                    <button class="${escape$4(null_to_empty(`px-1 btn ${textAlign === "start" ? "btn-primary" : "btn-light"}`)) + " svelte-2sm8o1"}">${validate_component(Icon, "Icon").$$render($$result, { name: "text-left" }, {}, {})}</button>
                    <button class="${escape$4(null_to_empty(`px-1 btn ${textAlign === "center" ? "btn-primary" : "btn-light"}`)) + " svelte-2sm8o1"}">${validate_component(Icon, "Icon").$$render($$result, { name: "text-center" }, {}, {})}</button>
                    <button class="${escape$4(null_to_empty(`px-1 btn ${textAlign === "end" ? "btn-primary" : "btn-light"}`)) + " svelte-2sm8o1"}">${validate_component(Icon, "Icon").$$render($$result, { name: "text-right" }, {}, {})}</button></div></div></div></div>
        <p class="${"my-3"}"><strong>Pr\xE9visualisation</strong></p>
        <div class="${"row"}"><div class="${"col"}"${add_attribute("style", `text-align: ${textAlign};`, 0)}><button class="${escape$4(null_to_empty(`btn ${btnColor}`)) + " svelte-2sm8o1"}">T\xE9l\xE9charger</button></div></div>`
      })}
    ${validate_component(ModalFooter, "ModalFooter").$$render($$result, {}, {}, {
        default: () => `<button class="${"btn btn-primary"}">Enregistrer</button>
        <button class="${"btn btn-secondary"}">Cancel</button>`
...
<div class="${"content-container svelte-2sm8o1"}"><div class="${"row"}">${values[0] && values[0].url ? `<div class="${"col"}"${add_attribute("style", `text-align: ${textAlign};`, 0)}><button class="${escape$4(null_to_empty(`btn ${btnColor}`)) + " svelte-2sm8o1"}">T\xE9l\xE9charger</button></div>` : ``}</div>
...
${type === "compressComponent" ? `${validate_component(CompressFileComponent, "CompressFileComponent").$$render($$result, {
      updateContent,
      admin,
      edit: edit2,
      values,
...
${type === "sousligneComponent" ? `${validate_component(SouslligneComponent, "SouslligneComponent").$$render($$result, {
      updateContent,
      admin,
      edit: edit2,
      values,
...
async function load({ page: page2 }) {
  ...
  if (redirection.length === 1) {
    ...
    return {
      status: 200,
      props: { pageRequest: pageRequest2, params, page: page2 }
    };
  } else {
    return {
      status: 307,
...
${pageRequest2.loading ? `${validate_component(Loading, "Loading").$$render($$result, { color: "secondary", number: 3 }, {}, {})}` : `
        ${validate_component(Row, "Row").$$render($$result, {}, {}, {
      default: () => `
            ${validate_component(Col, "Col").$$render($$result, {}, {}, {
