...
<div class='row py-1'><div class='col'>
    <button class={`px-1 border rounded btn ${textAlign === "text-start" ? "btn-primary border border-secondary" : "btn-light"}`} on:click={() => styles = updateStyle(styles, {name:'text-align', value:'text-start'})}><Icon name='text-left' /></button>
    <button class={`px-1 border rounded btn ${textAlign === "text-center" ? "btn-primary border border-secondary" : "btn-light"}`} on:click={() => styles = updateStyle(styles, {name:'text-align', value:'text-center'})}><Icon name='text-center' /></button>
    <button class={`px-1 border rounded btn ${textAlign === "text-end" ? "btn-primary border border-secondary" : "btn-light"}`} on:click={() => styles = updateStyle(styles, {name:'text-align', value:'text-end'})}><Icon name='text-right' /></button>
    <button class={`px-1 border rounded btn ${shadow === "shadow" ? "btn-primary border border-secondary" : "btn-light"}`} on:click={() => styles = updateStyle(styles, {name:'shadow', value:'shadow'})}><Icon name='back' /></button>
    <button class={`px-1 border rounded btn ${shadow === "" ? "btn-primary border border-secondary" : "btn-light"}`} on:click={() => styles = updateStyle(styles, {name:'shadow', value:''})}>No shadow</button>
    <button class={`px-1 border rounded btn ${rounded === "" ? "btn-primary border border-secondary" : "btn-light"}`} on:click={() => styles = updateStyle(styles, {name:'rounded', value:''})}><Icon name='square' /></button>
    <button class={`px-1 border rounded btn ${rounded === "rounded-3" ? "btn-primary border border-secondary" : "btn-light"}`} on:click={() => styles = updateStyle(styles, {name:'rounded', value:'rounded-3'})}><Icon name='app' /></button>
    <button class={`px-1 border rounded btn ${rounded === "rounded-circle" ? "btn-primary border border-secondary" : "btn-light"}`} on:click={() => styles = updateStyle(styles, {name:'rounded', value:'rounded-circle'})}><Icon name='circle' /></button>
</div></div>
...
<p class='my-3 border-bottom'><strong>Preview</strong></p>
<div class='row'>
