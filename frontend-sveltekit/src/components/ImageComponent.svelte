    ...
    <Row>
        <Col class={`col`}>
            ...
            <div class='row py-1'><div class='col'>
                <button class={`px-1 btn ${textAlign === "text-start" ? "btn-primary border border-dark" : "btn-light"}`} on:click={() => updateStyle({name:'text-align', value:'text-start'})}><Icon name='text-left' /></button>
                <button class={`px-1 btn ${textAlign === "text-center" ? "btn-primary border border-dark" : "btn-light"}`} on:click={() => updateStyle({name:'text-align', value:'text-center'})}><Icon name='text-center' /></button>
                <button class={`px-1 btn ${textAlign === "text-end" ? "btn-primary border border-dark" : "btn-light"}`} on:click={() => updateStyle({name:'text-align', value:'text-end'})}><Icon name='text-right' /></button>
            </div></div>
            <div class='row py-1'>
                <div class='col'>
